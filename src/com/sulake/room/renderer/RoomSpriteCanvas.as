package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_764:int = 50;
      ...
      private var var_1892:Number = -10000000;
      
      private var var_1896:Number = -10000000;
      
      private var var_2343:int = 0;
      
      private var var_481:RoomObjectCache;
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_53.graphics.beginFill(var_2343);
      ...
      {
         var _loc11_:Number = param1 - var_681 / 2;
         var _loc12_:Number = param2 - var_679 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(var_681 != var_1895 || var_679 != var_1893)
         {
            _loc10_ = true;
         }
         _loc5_ = 0;
         ...
         if(_loc6_ < var_407.length)
         {
            var_407.splice(_loc6_);
         }
         var _loc11_:* = null;
         _loc5_ = 0;
         while(_loc5_ < _loc6_)
         {
            _loc11_ = var_407[_loc5_] as SortableSprite;
            if(_loc11_ != null)
            {
         ...
         var_680.push(_loc12_ - _loc2_);
         if(var_680.length == const_764)
         {
            _loc13_ = 0;
            _loc14_ = 0;
            while(_loc14_ < const_764)
            {
               _loc13_ += var_680[_loc14_];
               _loc14_++;
            }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_482.length)
            {
               cleanSprite(var_482[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_482 = [];
         }
         ...
         while(_loc1_ < var_307.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1016 != null)
                  {
                     var_1016.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1478,geometry);
                  }
                  else
                  {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1892 || param2 != var_1896)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_482.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean) : int
      {
         ...
         if(_loc5_ == null)
         {
            var_481.removeObjectCache(param2);
            return 0;
         }
         var _loc6_:RoomObjectCacheItem = var_481.getObjectCache(param2);
         ...
         _loc12_ += int(var_681 / 2);
         _loc13_ += int(var_679 / 2);
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc17_:* = null;
         var _loc18_:int = 0;
         ...
         while(_loc21_ < _loc11_)
         {
            ...
            if(_loc17_ != null && _loc17_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  ...
                  if(_loc18_ + _loc22_.width >= 0 && _loc18_ < var_681 && (_loc19_ + _loc22_.height >= 0 && _loc19_ < var_679))
                  {
