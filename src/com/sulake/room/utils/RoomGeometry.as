package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_869:Number = 32;
      ...
      private var var_1570:Number = 1;
      
      private var var_2351:Number = 500;
      ...
      private var var_2352:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_82 = new Vector3d();
         var_1078 = new Vector3d();
         var_1571 = 1;
         var_1569 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1570 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      {
         if(var_429 != param1 * var_1570)
         {
            var_429 = param1 * var_1570;
            ++var_78;
         }
      }
      ...
      {
         if(var_431 != param1 * var_1571)
         {
            var_431 = param1 * var_1571;
            ++var_78;
         }
      }
      ...
      {
         if(var_432 != param1 * var_1569)
         {
            var_432 = param1 * var_1569;
            ++var_78;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_430 != null)
         {
            ...
            var_430.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_430.add(_loc3_,_loc4_);
            ++var_78;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_1078.assign(_loc22_);
         }
         else
         {
            var_1078.assign(_loc17_);
         }
         ++var_78;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_432;
         _loc2_.z *= var_429;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_1078);
         if(_loc3_ < var_2352 || _loc3_ > var_2351)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_432;
            _loc2_.z *= var_429;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_1078);
         }
      ...
      {
         return new Vector3d(0 * var_431,0 * var_432,0 * var_429);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_430 != null)
         {
            ...
            return var_430.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_431,0 * var_432,0 * var_429);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_82;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_431,param2.y * var_432,param2.z * var_429);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_431,param3.y * var_432,param3.z * var_429);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_431,param4.y * var_432,param4.z * var_429);
