package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_721 == null || _loc3_ < 0 || _loc3_ >= var_721.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_721[_loc3_];
            main.showUI(HabboHelpViewEnum.const_612);
            main.tellUI(HabboHelpViewEnum.const_612,null);
         }
      }
   }
}
