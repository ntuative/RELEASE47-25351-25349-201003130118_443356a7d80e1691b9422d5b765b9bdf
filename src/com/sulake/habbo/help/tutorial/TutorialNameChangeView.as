package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1391:uint = 13232628;
      
      private static var var_1636:uint = 11129827;
      ...
      private var var_245:IBorderWindow;
      
      private var var_765:NameSuggestionListRenderer;
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(var_245 == null)
         {
            var_245 = _main.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_245 == null)
            {
               return;
            }
            ...
            _loc2_.addChild(var_245);
            var_245.procedure = confirmationViewEventHandler;
         }
         _window.visible = !param1;
         var_245.visible = param1;
      }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1596 || param1 == ChangeUserNameResultMessageEvent.var_1595)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         var_765 = new NameSuggestionListRenderer(_main);
         var _loc6_:int = var_765.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1391;
