package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_397:ToolbarBarMenuAnimator;
      
      private var var_1345:Array;
      
      private var var_120:Number;
      
      private var var_2198:XML;
      ...
      public function getIconByMenuId(param1:String) : ToolbarIcon
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_319.length)
         {
            _loc2_ = var_319[_loc3_];
            if(_loc2_ != null)
            {
      ...
      {
         return var_744.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = var_744.indexOf(var_1345[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_319[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_907 + _loc3_);
                  _loc3_ += var_1344;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_397);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_744.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_319[var_744.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_2198.elements("menu");
         var _loc5_:int = 0;
