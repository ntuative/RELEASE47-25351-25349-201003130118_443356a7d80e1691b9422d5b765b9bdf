package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1039:Number = 25;
      
      private static const const_1101:int = 50;
      
      private static const const_187:Boolean = true;
       
      
      private var var_600:Timer;
      
      private var var_1061:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_1061 = param2;
         var_600 = new Timer(const_1039);
         var_600.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = var_508.indexOf(param2);
         if(_loc3_ > -1)
         {
            var_508.splice(_loc3_,1);
            var_509.splice(_loc3_,1);
         }
         var_509.push(param1.name);
         var_508.push(param2);
         param1.addEventListener(WindowEvent.const_430,windowEventListener);
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_1061.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = var_1061.getIconLoc(param1.iconId);
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_599[_loc3_] = new Array();
            }
            if(var_599[_loc3_].indexOf(param1) < 0)
            {
               var_599[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_775 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_775 || param1.desktop.height - param1.y < const_1101;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < var_509.length)
         {
            if(var_509[_loc2_] == param1.window.name)
            {
               _loc3_ = "null";
               if(false)
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_599[_loc3_].length)
                  {
                     repositionWindow(var_599[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
