package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_168:HabboHotelView;
      ...
      private var var_1702:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1416:ILogger;
      
      private var var_1158:String;
      
      private var var_1701:String;
      
      private const const_1404:String = "fuselogin";
      
      private var var_297:ICoreCommunicationManager;
      
      private var var_384:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_296:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_935:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_971:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1703)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_646 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_646);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1158,var_1701));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1404,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_384.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_384.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1702);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1404,"/");
      ...
      {
         var_646 = _habboConfiguration.getKey("sso.ticket",null);
         var_1158 = _habboConfiguration.getKey("flash.client.url","");
         var_1701 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_168 == null)
         {
            var_168 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_646 != null)
         {
            var_70.mode = HabboConnectionType.const_441;
            var_70.initConnection(HabboConnectionType.const_259);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1416 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_635);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1702 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_70.mode)
         {
            case HabboConnectionType.const_441:
               _loc6_ = "";
               ...
               var_966 = _loc4_;
               var_168.loadBannerImage(_loc7_ + "?token=" + var_966,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1304:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1227:
               var_552 = generateRandomHexString(30);
               var_384 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_384.init(var_552);
               _loc8_ = var_384.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_168.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_966);
         ...
         var_384 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = generateRandomHexString(30);
            var_384.init(_loc14_);
            _loc15_ = var_384.getPublicKey(10);
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_20.events.addEventListener(RoomSessionEvent.const_105,onRoomSessionEnded);
      }
