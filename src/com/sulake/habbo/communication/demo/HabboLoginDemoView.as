package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_698:String = "InitConnection";
      ...
      private var var_364:HabboCommunicationDemo;
      ...
      {
         var_364.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_364.shockwaveClientUrl = var_117.shockwaveClientUrl;
         var_364.ssoTicket = var_117.ticket;
         var_117.removeEventListener(SSOTicket.const_302,onParsedTicketSuccess);
         var_117.removeEventListener(SSOTicket.const_258,onParsedTicketFailure);
         var_117 = null;
         dispatchEvent(new Event(const_698));
      }
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1404,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_364 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_364.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_400,HabboWindowStyle.const_41,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_364.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1404,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_364.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_364.habboCommunication.habboWebLogin(name,password);
         var_117 = new SSOTicket(var_364.assets,_loc2_,_loc1_);
         var_117.addEventListener(SSOTicket.const_302,onParsedTicketSuccess);
         var_117.addEventListener(SSOTicket.const_258,onParsedTicketFailure);
      }
