package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private function checkboxHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_705:
               showSelectors(false);
               break;
            case WindowEvent.const_720:
               showSelectors(true);
         }
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = var_236.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == var_867;
               }
            }
            _loc4_++;
         }
      ...
      private function updatePreview() : void
      {
         ...
         _loc3_ = _loc2_.getFurnitureImage(var_867,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               _catalog.purchaseProduct(var_568,var_75,var_1051);
               dispose();
               break;
            case "cancel_button":
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc1_:IItemListWindow = var_236.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(var_867);
         var _loc8_:int = !!_loc6_ ? 0 : int(var_592[var_198]);
         var _loc9_:int = !!_loc6_ ? 0 : int(var_593[_ribbonIndex]);
         _catalog.purchaseProductAsGift(var_568,var_75,var_1051,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_151:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(var_2047 == _loc3_.text)
               {
                  return;
               }
            ...
            case WindowMouseEvent.const_49:
               ...
               break;
            case WindowKeyboardEvent.const_641:
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = var_75.productContainer.firstProduct;
            switch(_loc6_.productType)
            {
               ...
               case ProductTypeEnum.const_211:
                  ...
                  break;
               case ProductTypeEnum.const_411:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            var_1418 = _loc1_.stuffTypes;
            var_592 = _loc1_.boxTypes;
            var_593 = _loc1_.ribbonTypes;
            var_867 = var_1418[0];
            var_198 = var_592[0];
            _ribbonIndex = var_593[0];
            initColorGrid();
            updateColorGrid();
            updatePreview();
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         var _loc2_:IItemListWindow = var_236.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(var_236 == null)
         {
            var_236 = _window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(var_498 == null)
         {
            var_498 = createWindow("suggestion_list_item") as IWindowContainer;
            var_498.procedure = suggestionsEventHandler;
         }
         if(var_236 == null || var_498 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = var_236.findChildByName("suggestion_list") as IItemListWindow;
         ...
         {
            _loc5_ = var_498.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
