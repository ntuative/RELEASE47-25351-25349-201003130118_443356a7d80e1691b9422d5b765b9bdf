package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_196:PurchaseConfirmationDialog;
      ...
      private var var_1985:GiftWrappingConfiguration;
      ...
      private var var_1032:ClubGiftController;
      ...
      {
         return var_363.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_156.credits = _loc3_.balance;
         updatePurse();
         if(!var_1983 && var_489 != null)
         {
            var_489.playSound(HabboSoundTypesEnum.const_856);
         }
         var_1983 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_363.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_78)
         {
            _loc3_ = var_363.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onIsOfferGiftable(param1:IsOfferGiftableMessageEvent) : void
      {
         ...
         {
            this.var_196.onIsOfferGiftable(param1.getParser());
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_148.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         var_1985 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_182 != null && _loc2_)
         {
            var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         var_1032.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_156.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_156.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         updatePurse();
      ...
      private function createClubGiftController() : void
      {
         if(var_1032 == null)
         {
            var_1032 = new ClubGiftController(this);
         }
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_196 == null)
            {
               var_196 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_196.showOffer(this,param1,param2,param3,_loc7_);
      ...
      {
         var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function updatePurse() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_156.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_156.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_156.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_156.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_156.pixels = _loc2_.amount;
         updatePurse();
         if(!var_1984 && var_489 != null)
         {
            var_489.playSound(HabboSoundTypesEnum.const_866);
         }
         var_1984 = false;
      }
