package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_781:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1555)
         {
            case RecyclerStatusMessageEvent.const_1265:
               var_274 = const_349;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_928:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1303:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1555 != RecyclerStatusMessageEvent.const_928;
      }
      
      private function get statusActive() : Boolean
      {
         return var_274 != const_781;
      }
      
      public function method_16() : Array
      {
         if(var_697 == null)
         {
      ...
      {
         return active && var_274 == const_349;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_874:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1266:
