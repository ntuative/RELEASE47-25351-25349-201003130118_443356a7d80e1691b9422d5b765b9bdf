package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_560 != null)
         {
            var_560.visible = false;
            var_560.destroyGridItems();
         }
         if(var_1177 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1231.text = "${" + _loc3_.name + "}";
            var_1232.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1231.text = "${" + _loc2_.localizationId + "}";
            var_1232.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_454:
                  _loc4_ = var_1176.clone();
                  if(var_560 != null)
                  {
                     var_560.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_560,var_1177,var_1383);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_211:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_292,AvatarAction.const_631);
      ...
      {
         var_1231 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1232 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_84 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1431 = new Point(var_84.x,var_84.y);
         var_560 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1177 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_560 == null)
         {
         ...
         var_1176 = _loc2_.content as BitmapData;
