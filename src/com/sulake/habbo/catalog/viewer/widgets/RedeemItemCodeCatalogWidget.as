package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1003:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_1003 != null)
         {
            var_1003.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_1004 != null)
         {
            var_1004.removeEventListener(WindowKeyboardEvent.const_138,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_1003 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_1003 != null)
         {
            var_1003.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_1004 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_1004 != null)
         {
            var_1004.addEventListener(WindowKeyboardEvent.const_138,windowKeyEventProcessor);
         }
      }
