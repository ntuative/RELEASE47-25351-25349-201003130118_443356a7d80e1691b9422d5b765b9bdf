package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_457:Boolean = false;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_381 >= var_295.length)
         {
            return "";
         }
         var petColor:IPetColor = var_295[var_381] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_550[var_1412] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         if(var_381 < 0 || var_381 > var_295.length)
         {
            var_381 = 0;
         }
         updateImage();
      ...
      private function onApproveNameResult(param1:CatalogWidgetApproveNameResultEvent) : void
      {
         ...
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(var_532.getWithIndex(0),page,p);
      }
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_151,onTextWindowEvent);
         var_532 = new Map();
         ...
         events.addEventListener(WidgetEvent.const_854,onApproveNameResult);
         _loc5_ = var_532.getWithIndex(0);
         if(_loc5_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc1_:Offer = var_532.getWithIndex(0);
         if(_loc1_ == null)
         {
            return;
         }
         ...
         if(var_381 >= 0 && var_381 < var_295.length)
         {
            _loc7_ = var_295[var_381] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_550[var_1412] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_779,_loc3_.id,_loc2_,AvatarScaleType.const_52);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_292,AvatarAction.const_512);
