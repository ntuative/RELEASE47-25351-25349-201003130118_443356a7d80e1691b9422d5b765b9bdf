package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private var var_761:MarketPlaceOfferData;
      
      private const const_1403:int = 1;
      
      private const const_1615:int = 40;
      
      private var var_447:IWindowContainer;
      
      private const const_1402:int = 2;
      ...
      private const const_1616:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!var_447)
         {
            ...
            var_447 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!var_447)
         {
            return;
         ...
         updateStatusDisplay(const_1402,_loc2_.length);
         if(!var_374)
         {
            var_374 = new Timer(25);
            var_374.addEventListener(TimerEvent.TIMER,onPopulationTimer);
         }
         var_760 = 0;
         populateList();
         var_374.start();
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         if(!marketPlace || !param2 || !_itemList || !var_532)
         {
            return;
         }
         var _loc3_:* = [];
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !_itemList || !var_447 || true)
         {
            return;
         }
         var _loc2_:IWindowContainer = var_447.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         updateStatusDisplay(const_1403);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < var_375.length)
         {
            _loc4_ = 0;
         }
      ...
      override public function dispose() : void
      {
         ...
         if(var_374)
         {
            var_374.removeEventListener(TimerEvent.TIMER,onPopulationTimer);
            var_374 = null;
         }
      }
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(var_760 >= var_532.length)
            {
               return true;
            }
            addListItem(var_532.getWithIndex(var_760));
            ++var_760;
            _loc1_++;
         }
         return false;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  marketPlace.buyOffer(var_761.offerId);
            }
            return;
         }
      ...
      private function onWidgetEvent(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowEvent.const_151)
         {
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(getSortKeys(var_375));
            _loc7_.selection = 0;
         }
      }
