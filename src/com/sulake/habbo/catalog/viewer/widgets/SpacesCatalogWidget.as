package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1195:String = "default";
      ...
      private var var_1196:String = "1.1";
      ...
      private var var_275:BitmapData = null;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_277 != null && var_275 != null)
         {
            setRoomImage(var_277,var_275);
         }
      }
         ...
         switch(param1)
         {
            ...
            case const_189:
               ...
               for each(_loc9_ in var_148.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_737 = _loc9_.children().length();
                  }
               }
            ...
            case const_188:
               ...
               for each(_loc10_ in var_148.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_736 = _loc10_.children().length();
                  }
               }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1195);
               }
               break;
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1195,var_1196,64,this,"window_romantic_wide");
