package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1383:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_845:PrizeViewer;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         var_845 = new PrizeViewer();
         var_532 = new Map();
         var_697 = recycler.method_16();
         if(var_697 == null)
         {
            return;
         }
         ...
         var_1978 = _loc1_.content as XML;
         populateItemGrid();
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1978) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1383) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_845.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
