package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1226 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_310 = null;
         for each(_loc1_ in var_1227)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1226) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_660.width,var_660.height,true,0);
               _loc3_.bitmap.copyPixels(var_660,var_660.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_808.width,var_808.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_661.width,var_661.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_661,var_661.rect,new Point(0,0),null,null,true);
