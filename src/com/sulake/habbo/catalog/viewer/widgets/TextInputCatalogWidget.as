package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         var_1090 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_1090 != null)
         {
            var_1090.addEventListener(WindowKeyboardEvent.const_641,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_1090.text));
      }
   }
}
