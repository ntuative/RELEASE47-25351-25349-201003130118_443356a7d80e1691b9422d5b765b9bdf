package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1125:IProductData;
      ...
      {
         super();
         var_1126 = param1.productType;
         var_1124 = param1.furniClassId;
         var_948 = param1.extraParam;
         var_947 = param1.productCount;
         var_1123 = param1.expiration;
         var_1125 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_78:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_948);
               break;
