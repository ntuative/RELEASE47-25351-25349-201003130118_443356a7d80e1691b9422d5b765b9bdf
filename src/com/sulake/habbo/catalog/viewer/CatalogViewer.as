package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1442:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array) : void
      {
         ...
         if(var_568 != null)
         {
            if(var_568.pageId == param1)
            {
               return;
            }
            _container.removeChild(var_568.window);
            var_568.dispose();
         }
         var _loc5_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,var_1442);
         var_568 = _loc5_;
      ...
      {
         return var_568.dispatchWidgetEvent(param1);
      }
