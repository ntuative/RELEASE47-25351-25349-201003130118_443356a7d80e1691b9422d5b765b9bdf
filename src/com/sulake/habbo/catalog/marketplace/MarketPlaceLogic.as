package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      private var var_1665:MarketplaceItemStats;
      ...
      private var var_196:MarketplaceConfirmationDialog;
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         showConfirmation(const_1512,_loc2_);
      }
      ...
      {
         if(param1.furniCategoryId != var_1668 || param1.furniTypeId != var_1664)
         {
            return;
         }
         var_1665 = param1;
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         var_1609 = _loc3_.creditsWaiting;
         var_184 = new Map();
      ...
      private function showConfirmation(param1:int, param2:MarketPlaceOfferData) : void
      {
         if(!var_196)
         {
            var_196 = new MarketplaceConfirmationDialog(this,_catalog,_roomEngine);
         }
         var_196.showConfirmation(param1,param2);
      }
      ...
      {
         requestOffers(var_1662,var_1661,var_1663,var_1666);
      }
