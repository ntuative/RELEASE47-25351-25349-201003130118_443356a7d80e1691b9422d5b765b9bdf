package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1037:UserDataManager;
      ...
      public function method_15(param1:int) : void
      {
      ...
      {
         if(var_35 == RoomSessionEvent.const_283 && _connection != null)
         {
            var_35 = RoomSessionEvent.const_90;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1037 as IUserDataManager;
      }
