package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_740:uint = 11;
       
      
      private var var_210:LatencyTracker = null;
      
      private var var_211:PerformanceTracker = null;
      ...
      private var var_766:LagWarningLogger = null;
      
      private var var_767:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_211 = new PerformanceTracker();
         var_210 = new LatencyTracker();
         var_766 = new LagWarningLogger();
         var_1137 = new Array(const_740);
         var _loc4_:int = 0;
         while(_loc4_ < const_740)
         {
            var_1137[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1252,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1296,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1234,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_711,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_893,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               trackLoginStep(HabboLoginTrackingStep.const_1362);
               break;
            case HabboCommunicationEvent.const_635:
               trackLoginStep(HabboLoginTrackingStep.const_1309,String(_communication.port));
               break;
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(var_210 != null)
            {
               var_210.communication = _communication;
               var_210.connection = param1;
            }
            if(var_766 != null)
            {
               var_766.connection = param1;
            }
         }
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_318:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_148)
         {
            Component(var_148).events.addEventListener(HabboConfigurationEvent.const_165,onConfigurationLoaded);
            if(var_210 != null)
            {
               var_210.configuration = var_148;
            }
            if(var_211 != null)
            {
               var_211.configuration = var_148;
            }
            if(var_766 != null)
            {
               var_766.configure(var_148);
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_283.events.addEventListener(AdEvent.const_351,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_893,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_711,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_635,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_586,onHotelViewEvent);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_767)
            {
               var_767.release(new IIDHabboWindowManager());
               var_767 = null;
            }
            if(var_283)
            {
            ...
            if(var_165)
            {
               if(true)
               {
                  ...
                  Component(var_165).events.removeEventListener(HabboFriendListTrackingEvent.const_318,onFriendlistTrackingEvent);
               }
            ...
            if(var_127)
            {
               if(true)
               {
                  var_127.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_127.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_127.release(new IIDHabboHelp());
               var_127 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_148)
         {
            Component(var_148).events.removeEventListener(HabboConfigurationEvent.const_165,onConfigurationLoaded);
         }
      }
      ...
      {
         var_127 = param2 as IHabboHelp;
         var_127.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_127.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         trackLoginStep(HabboLoginTrackingStep.const_790);
         if(_coreComponent != null)
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_790,onCoreRunning);
         }
      }
      ...
      {
         var_767 = IHabboWindowManager(param2);
         if(var_767)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_951 > -1 && _loc2_ < var_951)
         {
            ++var_1399;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1399);
         }
         if(var_951 > -1 && _loc2_ - var_951 > 15000)
         {
            ++var_1400;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1400);
         }
         var_951 = _loc2_;
         if(var_211 != null)
         {
      ...
      {
         if(var_148 != null && Boolean(var_148.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_165).events.addEventListener(HabboFriendListTrackingEvent.const_318,onFriendlistTrackingEvent);
      }
         ...
         if(param1.critical && !_crashed)
         {
            ...
            if(var_148)
            {
               if(var_148.keyExists("client.fatal.error.url"))
               {
                  ...
                  if(var_211 != null)
                  {
                     _loc4_["null"] = var_211.flashVersion;
                     _loc4_["null"] = var_211.averageUpdateInterval;
                  }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_586)
         {
