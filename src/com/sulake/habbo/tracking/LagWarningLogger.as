package com.sulake.habbo.tracking
{
   ...
   public class LagWarningLogger
   {
      ...
      {
         var _loc2_:* = null;
         if(!var_1143 || var_1503 <= 0)
         {
            return;
         }
         var _loc1_:int = getTimer();
         if(var_1504 == 0 || _loc1_ - var_1504 > var_1503)
         {
            if(_connection != null)
            {
      ...
      {
         var_1143 = Boolean(int(param1.getKey("lagWarningLog.enabled","0")));
         var_1503 = int(param1.getKey("lagWarningLog.interval.minutes","10")) * 1000 * 60;
      }
