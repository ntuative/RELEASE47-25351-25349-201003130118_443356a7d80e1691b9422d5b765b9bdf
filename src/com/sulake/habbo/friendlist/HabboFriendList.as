package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1586:OpenedToWebPopup;
      
      private var var_769:IAvatarRenderManager;
      
      private var var_182:IHabboToolbar;
      
      private var var_380:FriendListTabs;
      ...
      private var var_1587:AvatarSearchResults;
      ...
      private var var_2250:FriendListLookAndFeel;
      ...
      {
         var_2250 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_15 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1587 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_380.findTab(FriendListTab.const_87).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_15.addCategory(new FriendCategory(FriendCategory.const_967,getText("friendlist.friends")));
         var_15.addCategory(new FriendCategory(FriendCategory.const_466,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_15.addFriend(new Friend(_loc4_));
         }
         var_380 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!var_524)
         {
            var_524 = new Timer(120000);
            var_524.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_524.start();
         }
         getBuddyRequests();
         registerListeners();
         var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.FRIENDLIST));
      ...
      override public function dispose() : void
      {
         ...
         {
            var_524.stop();
            var_524.removeEventListener(TimerEvent.TIMER,sendFriendListUpdate);
            var_524 = null;
         }
         if(_windowManager)
         {
         ...
         if(var_132)
         {
            var_132.release(new IIDHabboMessenger());
            var_132 = null;
         }
         if(var_148)
         {
         ...
         if(var_769)
         {
            var_769.release(new IIDAvatarRenderManager());
            var_769 = null;
         }
         if(var_924)
         {
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_380.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_318));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var_182 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1587.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         var_182.events.dispatchEvent(_loc1_);
      }
      ...
      {
         var _loc2_:FriendListTab = var_380.findTab(FriendListTab.const_87);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc2_:IAvatarImage = var_769.createAvatarImage(param1,AvatarScaleType.const_100);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_380.findTab(FriendListTab.const_87);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_769 = param2 as IAvatarRenderManager;
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1586 == null)
         {
            var_1586 = new OpenedToWebPopup(this);
         }
         var_1586.show(x,y);
      }
