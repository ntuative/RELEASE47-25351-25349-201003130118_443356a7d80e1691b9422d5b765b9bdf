package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1432:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_299 && _loc4_.state != FriendRequest.const_337)
            {
      ...
      {
         var_1577 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1576 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1576.procedure = onDismissAllButtonClick;
         var_1577.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_153)
         {
         ...
         else if(param1.state == FriendRequest.const_1008)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1577,_loc1_);
         setEnabled(var_1576,_loc1_);
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_299;
