package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      private var var_1732:IContainerButtonWindow;
      
      private var var_1735:IContainerButtonWindow;
      
      private var var_1733:IContainerButtonWindow;
      
      private var var_1734:IContainerButtonWindow;
      ...
      {
         var_1735 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1733 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1732 = initButton("room_invite",onInviteButtonClick,param1);
         var_1734 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_248)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_248 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1735,isEnableMinimailButton(_loc1_));
         setEnabled(var_1733,isEnableHomeButton(_loc1_));
         setEnabled(var_1732,isEnableInviteButton(_loc1_));
         setEnabled(var_1734,isEnableRemoveButton(_loc1_));
      }
