package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_639 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_639.procedure = onSearchInput;
         var_639.addEventListener(WindowKeyboardEvent.const_138,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            var_50.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_311,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_639.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
