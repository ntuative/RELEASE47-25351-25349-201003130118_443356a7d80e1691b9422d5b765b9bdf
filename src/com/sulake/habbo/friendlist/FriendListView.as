package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1419:String = "noconvinfo";
      ...
      private var var_1286:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         super();
         _friendList = param1;
         var_1286 = new FriendListTabsView(_friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         var_843 = IWindowContainer(var_14.content.findChildByName("main_content"));
         var_282 = IWindowContainer(var_14.content.findChildByName("footer"));
         var_1286.prepare(var_843);
         var_14.procedure = onWindow;
         var_14.content.setParamFlag(HabboWindowParam.const_958,false);
         var_14.content.setParamFlag(HabboWindowParam.const_1308,true);
         var_14.header.setParamFlag(HabboWindowParam.const_614,false);
         var_14.header.setParamFlag(HabboWindowParam.const_804,true);
         var_14.content.setParamFlag(HabboWindowParam.const_614,false);
         var_14.content.setParamFlag(HabboWindowParam.const_804,true);
         var_14.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1285 = ITextWindow(var_14.findChildByName("info_text"));
         var_1285.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_282.y = Util.getLowestPoint(var_14.content);
         ...
         var_14.scaler.setParamFlag(HabboWindowParam.const_842,this._friendList.tabs.findSelectedTab() != null);
         var_14.scaler.setParamFlag(HabboWindowParam.const_614,false);
         var_14.scaler.setParamFlag(HabboWindowParam.const_958,false);
         var_14.scaler.x = 0 - var_14.scaler.width;
         var_14.scaler.y = 0 - var_14.scaler.height;
         var_1523 = var_14.height;
         var_1524 = var_14.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1523 == -1 ? 0 : int(0 - var_1523);
         var _loc4_:int = var_1524 == -1 ? 0 : int(0 - var_1524);
