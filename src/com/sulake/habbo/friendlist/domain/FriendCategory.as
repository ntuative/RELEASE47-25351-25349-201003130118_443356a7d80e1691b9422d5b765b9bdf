package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         return Math.ceil(this.var_230.length / const_308);
      }
      ...
      {
         if(this.var_830 >= this.getPageCount())
         {
            this.var_830 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_830 + 1) * const_308,this.var_230.length);
      }
