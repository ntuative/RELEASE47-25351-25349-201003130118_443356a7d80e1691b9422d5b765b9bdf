package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1452:Number = 1;
      
      private var _b:uint;
      
      private var var_1453:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1451,var_1453,var_1452,_alphaMultiplier);
         var_1054 = generatePaletteMapForGrayscale(var_2076,var_2077);
      }
      
      public function get reds() : Array
      {
         return var_1054.getValue("reds") as Array;
      }
      ...
      {
         return var_1054.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1054.getValue("greens") as Array;
      }
      ...
      {
         return var_1054.getValue("alphas") as Array;
      }
