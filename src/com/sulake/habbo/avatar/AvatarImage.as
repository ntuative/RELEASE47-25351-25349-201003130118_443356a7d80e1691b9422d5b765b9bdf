package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1042:String = AvatarSetType.const_39;
      ...
      private var var_541:AvatarFigureContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_186 == null)
         {
            var_186 = AvatarScaleType.const_52;
         }
         ...
         var_541 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_541.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_958;
         }
         var_135 = new AvatarImageCache(var_69,this,_assets,var_186);
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1146;
         if(param2 < AvatarDirectionAngle.const_1244)
         {
            param2 = AvatarDirectionAngle.const_684 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_684)
         {
            param2 -= NaN;
         }
         if(var_748 == AvatarType.PET && param1 == AvatarSetType.const_47)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_69.sortActions(var_187);
         if(_loc1_ == null)
         {
            var_542 = new Array(0,0,0);
         }
         else
         {
            var_542 = var_69.getCanvasOffsets(_loc1_,var_186,var_90);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_1146 = _loc3_.directionData.offset;
                  }
            ...
            if(_loc2_.actionType == AvatarAction.const_598)
            {
               _isAnimating = true;
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_439)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_69.getPartColor(var_541,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_69.getCanvas(var_186,var_166.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_69.getBodyParts(param1,var_166.definition,var_90);
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc10_ != null)
            {
               ...
               if(var_748 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_69.getParts(_loc9_,var_541,_loc15_,"pet",_loc14_.getDirection(),[]);
                  _loc18_ = 32;
                  if(var_186 == AvatarScaleType.const_100)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     ...
                     _loc23_ = var_69.getPartActionOffset(getSubType(),var_186,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_69.getCanvas(var_186,var_166.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_69.getBodyParts(param1,var_166.definition,var_90);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(var_748 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_69.getParts(_loc7_,var_541,_loc12_,"pet",_loc11_.getDirection(),[]);
                  ...
                  if(_loc14_.length > 0)
                  {
                     ...
                     _loc21_ = var_69.getPartActionOffset(getSubType(),var_186,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_166 = new ActiveActionData(AvatarAction.const_1020);
         var_166.definition = var_69.getActionDefinition(const_1045);
      ...
      {
         return var_69.getBodyPartData(param1.animation.id,var_453,param1.id);
      }
            ...
            case AvatarAction.const_703:
               switch(_loc3_)
               {
                  ...
                  case AvatarAction.const_1335:
                     if(var_748 == AvatarType.const_77)
                     {
                        if(var_90 == 0)
                        {
