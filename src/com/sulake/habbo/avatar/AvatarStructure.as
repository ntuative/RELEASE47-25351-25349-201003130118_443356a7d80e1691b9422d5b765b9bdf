package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_2241:PartOffsetData;
      
      private var var_922:AvatarActionManager;
      
      private var var_178:IAssetLibrary;
      
      private var var_1093:IAssetLibrary;
      
      private var var_1371:Boolean = false;
      
      private var var_2240:AvatarRenderManager;
      ...
      private var var_1584:AvatarStructureDownloadSet;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_1584 = new AvatarStructureDownloadSet();
         var_749 = new AnimationManager();
         var_748 = param4;
         var_2241 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_922.getActionDefinitionWithState(param1);
      }
      ...
      {
         return var_922.getCanvasOffsets(param1,param2,param3);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         var_438.append(param1);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_922.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_749.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:ActionDefinition = var_922.getDefaultActionType();
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc10_ = var_749.getAnimation(_loc19_);
            if(_loc10_ != null)
            {
         ...
         for each(_loc16_ in _loc15_)
         {
            ...
            _loc25_ = var_438.getSetType(_loc16_);
            if(_loc25_ != null)
            {
               _loc26_ = var_438.getPalette(_loc25_.paletteID);
               if(_loc26_)
               {
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_748 + " ready to go!");
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_748)
         {
            case AvatarType.const_77:
               ...
               var_1584.add(new AvatarStructureDownload(var_178,_loc5_,var_438));
               break;
            case AvatarType.PET:
         }
         var_1584.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_749.getAnimation(param1);
      }
      ...
      {
         var_922 = new AvatarActionManager(var_178,var_748);
      }
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_1093.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_1093.getAssetByName("dance" + _loc1_).content as XML;
            var_749.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_1093.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_1093.getAssetByName("fx" + _loc1_).content as XML;
            var_749.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_922.sortActions(param1);
      }
   }
}
