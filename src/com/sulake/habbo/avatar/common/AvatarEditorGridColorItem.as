package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_662:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_991 = _loc8_.content as BitmapData;
         updateThumbData();
      }
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_660.width,var_660.height,true,0);
            _loc1_.bitmap.copyPixels(var_660,var_660.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_808.width,var_808.height,true,0);
            _loc4_ = var_808.clone();
            _loc4_.colorTransform(_loc4_.rect,var_662.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(_isSelected)
            {
               _loc3_.bitmap = new BitmapData(var_661.width,var_661.height,true,16777215);
               _loc3_.bitmap.copyPixels(var_661,var_661.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               {
                  _loc5_.bitmap.copyPixels(var_991,var_991.rect,new Point(0,0),null,null,true);
               }
            }
         }
      }
