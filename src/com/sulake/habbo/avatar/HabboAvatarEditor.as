package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_591:AvatarEditorHandler;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_709.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_1278)
         {
            ...
            var_15 = new Map();
            var_15.add(AvatarEditorCategory.const_924,new GenericModel(this));
            var_15.add(AvatarEditorCategory.const_47,new HeadModel(this));
            var_15.add(AvatarEditorCategory.const_322,new TorsoModel(this));
            var_15.add(AvatarEditorCategory.const_1282,new LegsModel(this));
            var_15.add(AvatarEditorCategory.const_899,new WardrobeModel(this));
            var_1278 = true;
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_591 = new AvatarEditorHandler(this,_communication);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc14_ in _loc10_.colors)
            {
               ...
               {
                  _loc17_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1593.clone() as IWindowContainer,param1,_loc14_);
                  _loc4_.push(_loc17_);
            ...
            if(_loc8_)
            {
               ...
               if(_loc19_)
               {
                  ...
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1367.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc21_ = false;
               if(_loc5_.gender == FigureData.const_1237)
               {
                  _loc21_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1367.clone() as IWindowContainer,param1,_loc5_,_loc12_,_loc15_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_15.getValue(AvatarEditorCategory.const_899);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_709.getPalette(param1);
      }
      ...
      {
         var_709 = var_590.getFigureData(AvatarType.const_77);
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_590 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_235 == null)
            {
               var_235 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_56,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_924);
         if(var_591 != null)
         {
            var_591.getWardrobe();
         }
