package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1417:int = 60000;
      ...
      private var var_925:IAvatarImage;
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_135.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_135.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc17_ != null)
            {
               ...
               if(_loc18_ != null)
               {
                  ...
                  else if(_loc18_.type == AnimationLayerData.const_468)
                  {
                     _loc4_ = _loc8_;
                  }
                  _loc7_ = true;
         ...
         if(_loc16_ == null)
         {
            ...
            _loc10_ = var_69.getParts(param1,(var_925 as AvatarImage).getFigure(),_loc6_,var_1279,_loc4_,_loc13_,_loc14_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_69.getCanvas(var_186,var_1279);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1196[param1])
            {
            ...
            _loc10_ = var_186 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_186 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_872 || _loc32_ == AvatarAction.const_598) && (_loc6_ == AvatarBodyPartType.const_322 || _loc6_ == AvatarBodyPartType.const_1193 || _loc6_ == AvatarBodyPartType.const_1169) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_186 == AvatarScaleType.const_52)
            {
               _loc30_.x += 67;
            }
            else
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_135 != null)
         {
            _loc2_ = var_135.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_135.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
