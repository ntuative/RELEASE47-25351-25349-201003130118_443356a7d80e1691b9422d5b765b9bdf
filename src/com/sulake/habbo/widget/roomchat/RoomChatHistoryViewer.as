package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1034:int = 18;
      ...
      private var var_209:Number = -1;
      
      private var var_147:RoomChatHistoryPulldown;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         _isDisposed = false;
         _widget = param1;
         var_147 = new RoomChatHistoryPulldown(param1,param2,param3,param4);
         var_147.state = RoomChatHistoryPulldown.const_222;
         ...
         var_43 = param2.createWindow("chatscroller","",HabboWindowType.const_848,HabboWindowStyle.const_41,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_209 > 0 && param2)
         {
            if(var_1132)
            {
               if(Math.abs(param1 - var_209) <= const_972)
               {
                  return;
               }
               var_1132 = false;
            ...
            if(var_292)
            {
               ...
               _loc5_ = (param1 - var_209) / 0;
               _loc3_ = var_328 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_209;
               _loc7_ = true;
               _loc8_ = true;
               if(var_43.scrollV < 1 - const_1034 / var_43.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1392)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_292 && !var_1320)
         {
            ...
            var_147.state = RoomChatHistoryPulldown.const_316;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_147.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_222);
      }
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(var_43 != null)
         {
            ...
            if(param2)
            {
               var_43.scrollV = var_328;
            }
         }
         if(var_147 != null)
         {
            var_147.containerResized(param1);
         }
      }
