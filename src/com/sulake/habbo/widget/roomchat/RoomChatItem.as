package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_1098:Number = 18;
      
      private static const const_1422:Number = 10;
      
      private static const const_1421:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_1058,var_1057,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_1058,var_718,var_1057,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_1058 = param1.userId;
         var_718 = param1.userName;
         var_1057 = param1.userCategory;
         _message = param1.text;
         var_1303 = param1.userX;
         var_200 = param1.userImage;
         var_1059 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1302)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_239:
               ...
               _loc2_ = true;
               break;
            case RoomWidgetChatUpdateEvent.const_249:
               _loc1_ = "bubble_generic";
               _loc2_ = true;
         }
         ...
         var_96 = _window as IRegionWindow;
         var_96.background = true;
         var_96.alphaTreshold = 0;
         enableTooltip();
         addEventListenerToChild(var_96);
         ...
         if(var_200 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_421 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_1059 != 0)
            {
               _loc30_ = uint(var_1059 >> 16 & 255);
               _loc31_ = uint(var_1059 >> 8 & 255);
               _loc32_ = uint(var_1059 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1302 == RoomWidgetChatUpdateEvent.const_239)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_718);
            }
            else if(var_1302 == RoomWidgetChatUpdateEvent.const_249)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_718);
            }
            else
            {
         ...
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_345 + _loc20_.textWidth + const_493;
            _loc37_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_1058,var_1057,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_1058,var_1057,_roomId,_roomCategory,param1);
      }
