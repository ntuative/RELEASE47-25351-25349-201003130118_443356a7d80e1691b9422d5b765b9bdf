package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private var var_403:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1055 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2080 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2079 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_713 = new Timer(1000,1);
         var_713.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_872 = new Timer(5000,1);
         var_872.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowEvent.const_151,onInputChanged);
         _window.addEventListener(WindowEvent.const_430,onWindowMoved);
         var_1297 = true;
         var_138 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2078 = _loc2_.width + const_493 + _loc6_.width + const_1093;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1092,_loc8_.width) + const_493);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1055 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_138 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_403);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_403);
         }
