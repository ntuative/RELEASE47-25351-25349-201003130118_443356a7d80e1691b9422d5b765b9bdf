package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private function onReleaseTimerTick(param1:TimerEvent) : void
      {
         ...
         {
            var_649 = var_649 - 1;
            _visualization.showFloodBlocking(var_649);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatInputDisplayEvent.const_716,onSettings);
      ...
      private function onChatInputUpdate(param1:RoomWidgetChatInputContentUpdateEvent) : void
      {
         ...
         switch(param1.messageType)
         {
            case RoomWidgetChatInputContentUpdateEvent.const_853:
               ...
               break;
            case RoomWidgetChatInputContentUpdateEvent.const_1180:
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatInputDisplayEvent.const_716,onSettings);
      ...
      private function checkForFlooding() : Boolean
      {
         ...
         if(var_389 > const_1048)
         {
            if(_loc1_ < var_1166 + const_1049)
            {
               var_788 = true;
               var_649 = const_1047 / 1000;
               Logger.log("Enabling flood blocking");
               var_789 = new Timer(1000,var_649);
               var_789.addEventListener(TimerEvent.TIMER,onReleaseTimerTick);
               var_789.addEventListener(TimerEvent.TIMER_COMPLETE,onReleaseTimerComplete);
               var_789.start();
               if(_visualization != null)
               {
                  _visualization.showFloodBlocking(var_649);
      ...
      private function refreshWindowPosition() : void
      {
         ...
         var _loc1_:RoomWidgetChatInputWidgetMessage = new RoomWidgetChatInputWidgetMessage(RoomWidgetChatInputWidgetMessage.const_506,_visualization.window);
         if(messageListener != null)
         {
