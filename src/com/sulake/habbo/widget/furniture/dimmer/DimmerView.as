package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1117:XML;
      
      private var var_381:int;
      
      private var var_445:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1608:int;
      
      private var var_327:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1029,const_1030,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_445 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_327 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_445 != null)
         {
            var_445.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_327 != null)
         {
            var_327.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_945 = _loc2_.light;
         if(var_327 != null)
         {
            var_327.setValue(var_945);
         }
         var_381 = colors.indexOf(_loc2_.color);
         if(var_445 != null)
         {
            var_445.setSelectedColorIndex(var_381);
         }
