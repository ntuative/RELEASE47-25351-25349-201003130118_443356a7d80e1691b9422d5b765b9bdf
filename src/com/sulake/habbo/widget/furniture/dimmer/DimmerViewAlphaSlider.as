package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewAlphaSlider
   {
      ...
      {
         if(param1.type != WindowMouseEvent.const_91 && param1.type != WindowMouseEvent.const_394)
         {
            return;
         }
      ...
      {
         return int(param1 / var_1573 * (var_1082 - var_745)) + var_745;
      }
   }
}
