package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      private var var_495:BitmapData;
      
      private var var_1272:XML;
      
      private var var_310:IWindowContainer;
      
      private var var_415:IItemGridWindow;
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_415.destroyGridItems();
         var_310 = null;
         for each(_loc2_ in colors)
         {
            _loc3_ = param1.buildFromXML(var_1272) as IWindowContainer;
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc3_.background = true;
            _loc3_.color = 4294967295;
            _loc3_.width = var_495.width;
            _loc3_.height = var_495.height;
            var_415.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_495.width,var_495.height,true,0);
               _loc4_.bitmap.copyPixels(var_495,var_495.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_855.width,var_855.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(var_706.width,var_706.height,true,16777215);
               _loc6_.bitmap.copyPixels(var_706,var_706.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = var_415.getGridItemIndex(param1.target as IWindow);
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= var_415.numGridItems)
         {
            return;
         }
         select(var_415.getGridItemAt(param1) as IWindowContainer);
      }
