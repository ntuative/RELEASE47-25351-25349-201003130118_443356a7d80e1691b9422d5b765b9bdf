package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1641:uint = 4.282169599E9;
      ...
      {
         var _loc2_:* = null;
         if(_itemList == null || param1 < 0 || param1 > _itemList.numListItems || param1 == var_727)
         {
            return;
         }
         if(var_727 != -1)
         {
            _loc2_ = _itemList.getListItemAt(var_727) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(var_727 % 2) ? uint(const_1424) : uint(const_1425);
            }
         }
         _loc2_ = _itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = const_1641;
            var_727 = param1;
         }
      }
