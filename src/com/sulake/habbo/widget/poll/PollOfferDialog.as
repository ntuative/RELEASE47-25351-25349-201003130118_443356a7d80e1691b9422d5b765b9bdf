package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_255:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_539:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1348:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     var_35 = const_1348;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_616,_id));
                     break;
                  case "poll_offer_button_cancel":
                     var_35 = const_539;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_354,_id));
