package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1429:String = "infostand_user_view";
      
      private var var_313:InfoStandPetView;
      
      private var var_1169:InfoStandPetData;
      ...
      private var var_362:InfoStandBotView;
      ...
      private const const_1428:String = "infostand_pet_view";
      
      private const const_1426:String = "infostand_furni_view";
      
      private const const_1642:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_898 = new InfoStandFurniView(this,const_1426);
         var_202 = new InfoStandUserView(this,const_1429);
         var_313 = new InfoStandPetView(this,const_1428);
         var_362 = new InfoStandBotView(this,const_1427);
         var_401 = new InfostandUserData();
         var_420 = new InfostandFurniData();
         var_1169 = new InfoStandPetData();
         var_141 = new Timer(const_1642);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_202.setTags(param1.tags,var_2145);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_516,onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_139,onUserTags);
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_154,onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_116,onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_724,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_402,var_313.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_516,onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_139,onUserTags);
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_154,onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_116,onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_724,onBadgeImage);
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(userData.isBot())
            {
               var_362.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_269:
               ...
               {
                  _loc2_ = param1.id == var_1169.roomIndex;
                  break;
               }
               if(var_362 != null && false && var_362.window.visible)
               {
                  _loc2_ = param1.id == var_401.userRoomId;
                  break;
               }
