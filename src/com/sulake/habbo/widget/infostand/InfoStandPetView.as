package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1627:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1622:String = "level";
      
      private var var_98:IItemListWindow;
      
      private const const_1623:String = "energy";
      
      private var var_1169:Map;
      
      private const const_1629:String = "nutrition";
      
      private var var_60:IItemListWindow;
      
      private const const_1624:uint = 3355443;
      
      private var var_215:IBorderWindow;
      
      private const const_1628:int = 158;
      
      private const const_1626:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_251:PetCommandTool;
      
      private const const_1625:uint = 11184810;
      
      private const const_1621:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_215 != null)
         {
            var_98 = var_215.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_98 == null || var_215 == null || var_60 == null)
         {
            return;
         }
         ...
         var_215.height = NaN;
         _window.width = Math.max(var_215.width,var_60.width);
      ...
      private function openTrainView() : void
      {
         if(var_251 == null)
         {
            var_251 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1169.getValue(var_710) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_251.showWindow(true);
            var_251.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1622,param1.level,param1.levelMax);
         updateStateElement(const_1621,param1.experience,param1.experienceMax);
         updateStateElement(const_1623,param1.energy,param1.energyMax);
         updateStateElement(const_1629,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_710 = param1.id;
         var_1169.remove(param1.id);
         var_1169.add(param1.id,param1);
         if(var_251 && var_251.isVisible() && param1.isOwnPet)
         {
            var_251.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_251.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_384,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1628,const_1626,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1625);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1624);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1627);
         return _loc5_;
      }
