   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_905 = _window.findChildByName("effect_hilite");
            var_905.visible = false;
         }
         var_906 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_904 = _window.findChildByName("loader_bar");
         if(var_904 != null)
         {
            var_403 = var_904.width;
            var_175.start();
            onUpdate();
         }
         if(false)
