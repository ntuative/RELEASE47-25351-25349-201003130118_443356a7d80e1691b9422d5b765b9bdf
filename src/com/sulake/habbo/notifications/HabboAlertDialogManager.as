package com.sulake.habbo.notifications
{
   ...
   public class HabboAlertDialogManager
   {
      ...
      public function handleLoginFailedHotelClosedMessage(param1:int, param2:int) : void
      {
         ...
         _localization.registerParameter("opening.hours.disconnected","h",method_3(openHour));
         _localization.registerParameter("opening.hours.disconnected","m",method_3(openMinute));
      ...
      public function handleHotelClosedMessage(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _localization.registerParameter("opening.hours.closed","h",method_3(openHour));
            _localization.registerParameter("opening.hours.closed","m",method_3(openMinute));
      ...
      private function method_3(param1:int) : String
      {
