package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      private static const const_404:int = 1;
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         if(_window.height < var_1549)
         {
            _window.height = var_1549;
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(var_35)
         {
            ...
            case const_404:
               var_899 += param1;
               _loc2_ = Number(var_899) / Number(var_424["time_fade_in"]);
               if(var_899 > int(var_424["time_fade_in"]))
               {
                  startDisplay();
               }
               adjustBlend(_loc2_);
            ...
            case const_777:
               var_1063 += param1;
               if(var_1063 > int(var_424["time_display"]) && !var_1315)
               {
                  startFadeOut();
               }
               break;
            case const_776:
               var_900 += param1;
               _loc3_ = 1 - Number(var_900) / Number(var_424["time_fade_out"]);
               adjustBlend(_loc3_);
               if(var_900 > int(var_424["time_fade_in"]))
               {
                  startIdling();
               }
         }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         var _loc3_:int = var_182.orientation == "TOP" ? int(const_348) : 0;
         var _loc4_:int = var_182.orientation == "BOTTOM" ? int(_loc2_.height - const_348) : int(_loc2_.height);
         var _loc5_:int = var_182.orientation == "LEFT" ? int(const_348) : 0;
         var _loc6_:int = var_182.orientation == "RIGHT" ? int(_loc2_.width - const_348) : int(_loc2_.width);
         if(false)
         {
            if(false)
            {
               _window.x = _loc5_ + const_375;
            }
            else
            {
               _window.x = _loc6_ - 0 - const_375;
            }
         }
         else if(false)
         {
