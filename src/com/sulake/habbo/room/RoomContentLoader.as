package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_745:String = "selection_arrow";
      
      private static const const_744:String = "tile_cursor";
      ...
      private static const const_1046:String = const_342;
      ...
      public static const const_503:String = "RCL_LOADER_READY";
      ...
      private var var_968:IEventDispatcher = null;
      
      private var var_1161:Map = null;
      ...
      public function RoomContentLoader()
      {
         var_461 = [];
         var_459 = [];
         var_1710 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1714 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_387 = new Map();
         _events = new Map();
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_307,_loc4_);
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_127 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(var_386 != null)
         {
            _loc2_ = var_386.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         if(var_169 != null && var_169.hasWorldType(const_278 + param1))
         {
            return var_169.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_459.indexOf(_loc14_) < 0)
                              {
                                 var_459.push(_loc14_);
                              }
                           }
      ...
      public function dispose() : void
      {
         ...
         if(var_387 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_387.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_332 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_332.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_387.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_554.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_387.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      {
         return [const_342,const_486,ROOM_CONTENT,const_744,const_745];
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1710.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_166 && _loc5_ != RoomObjectLogicEnum.const_127)
         {
            _loc6_ = "@shadow";
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return var_555.getValue(param1);
         }
         return "";
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1714.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = getVisualizationXML(_loc5_);
               _loc8_ = extractPublicRoomFromXML(_loc5_,_loc7_);
               var_1161.add(_loc5_,_loc8_);
               var_169 = _loc8_;
               extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_307,_loc5_);
         }
         else
         {
      ...
      private function continueInitilization() : void
      {
         if(var_1712)
         {
            ...
            if(var_968 != null)
            {
               var_968.dispatchEvent(new Event(const_503));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_169 != null)
         {
            return var_169.getWorldHeightScale(const_278 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_968 = param1;
            var_1711 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1715 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1716 = param2.getKey("public.room.dynamic.download.url","");
            var_1713 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         var_35 = const_746;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_332.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_386 != null)
         {
            var_386.remove(param2);
            var_386.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_166 && _loc5_ != RoomObjectVisualizationEnum.const_127)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_408.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_278 + param1) == RoomObjectCategoryEnum.const_66)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(var_1161.getValue(param1) != null)
         {
            var_169 = var_1161.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_437,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_169 != null)
         {
            return var_169.getWorldScale(const_278 + param1);
         }
         return 32;
      }
