package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1124:Number = 30;
      ...
      {
         var_740 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1329 = param3;
         var_2179 = param4 * 0 * 2 / 360;
         var_1561 = param5 * 0 * 2 / 360;
         _height = param6;
         var_907 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1329 * Math.cos(var_907 + var_1561);
         var _loc4_:Number = var_1329 * Math.sin(var_907 + var_1561);
         var _loc5_:Number = _height;
         var_740.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_740.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_740.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_740.add(param1);
         }
