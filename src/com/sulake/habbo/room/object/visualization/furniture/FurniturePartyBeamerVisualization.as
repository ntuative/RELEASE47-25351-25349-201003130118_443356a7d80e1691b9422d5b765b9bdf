package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_752:int = 15;
      
      private static const const_1061:int = 2;
      
      private static const const_341:int = 2;
      
      private static const const_751:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_983[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_982[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_983 = new Array();
         var_983.push(Math.random() * _loc2_ * 1.5);
         var_983.push(Math.random() * _loc2_ * 1.5);
         var_984 = new Array();
         var_984.push(1);
         var_984.push(-1);
         var_985 = new Array();
         var_985.push(const_1061);
         var_985.push(const_1062);
         var_982 = new Array();
         var_982.push(getRandomAmplitudeFactor());
         var_982.push(getRandomAmplitudeFactor());
      }
