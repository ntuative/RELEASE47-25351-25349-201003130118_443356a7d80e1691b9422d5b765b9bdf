package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1430:int = 0;
      ...
      private var var_884:AvatarVisualizationData = null;
      
      private const const_1100:int = 3;
      ...
      {
         var_884 = param1 as AvatarVisualizationData;
         createSprites(const_1100);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         var _loc11_:Number = _loc4_.getNumber(RoomObjectVariableEnum.const_528);
         ...
         var _loc14_:Number = _loc8_ - var_1319;
         ...
         var _loc20_:Boolean = var_287 != _loc3_.getUpdateID() || var_208 != param1.scale || var_162 != _loc4_.getUpdateID();
         var _loc21_:Boolean = _isAnimating || var_512 > 0;
         if(_loc20_ || _loc21_)
         {
            increaseUpdateId();
            --var_512;
            ...
            if(_loc6_ == null)
            {
               _loc6_ = var_884.getAvatar(_loc7_,param1.scale);
               if(_loc6_ == null)
               {
                  return;
               }
            ...
            _loc25_ = _loc4_.getNumber(RoomObjectVariableEnum.const_282);
            ...
            _loc27_ = _loc4_.getString(RoomObjectVariableEnum.const_549);
            _loc6_.appendAction(AvatarAction.const_703,_loc26_,_loc27_);
            _loc28_ = false;
            if(_loc26_ == "lay")
            {
            ...
            _loc29_ = _loc4_.getNumber(RoomObjectVariableEnum.const_399);
            if(_loc29_ > 0 && _loc6_.getScale() == AvatarScaleType.const_52)
            {
               _loc51_ = _loc4_.getNumber(RoomObjectVariableEnum.const_462);
               _loc52_ = 3;
               _loc53_ = _loc8_ - _loc51_;
               if(_loc53_ < _loc52_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_292,AvatarAction.const_1147[_loc29_]);
               }
            }
            _loc30_ = _loc4_.getNumber(RoomObjectVariableEnum.const_811);
            if(_loc30_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_995,_loc30_);
            }
            _loc31_ = _loc4_.getNumber(RoomObjectVariableEnum.const_802);
            if(_loc31_ > 0)
            {
               _loc54_ = _loc4_.getNumber(RoomObjectVariableEnum.const_847);
               _loc55_ = 5;
               _loc56_ = _loc8_ - _loc54_;
               if(_loc56_ < _loc55_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_982,_loc31_);
               }
            }
            _loc32_ = _loc4_.getNumber(RoomObjectVariableEnum.const_530);
            _loc33_ = 0;
            if(_loc32_ > 0)
            {
               _loc57_ = _loc4_.getNumber(RoomObjectVariableEnum.const_588);
               _loc58_ = 100;
               _loc59_ = _loc8_ - _loc57_;
               if(_loc59_ < _loc58_ * 1000)
               {
                  _loc6_.appendAction(AvatarAction.const_908,_loc32_);
                  _loc60_ = 1;
                  while(_loc60_ < 10)
                  {
            ...
            _loc34_ = _loc4_.getNumber(RoomObjectVariableEnum.const_843);
            if(_loc33_ > 0)
            {
               _loc34_ = _loc33_;
            }
            if(_loc34_ > 0)
            {
               _loc6_.appendAction(AvatarAction.const_1009,_loc34_);
            }
            if(_loc9_)
            {
               _loc6_.appendAction(AvatarAction.const_439);
            }
            _loc35_ = _loc4_.getNumber(RoomObjectVariableEnum.const_443) > 0;
            if(_loc35_ || _loc13_)
            {
               _loc6_.appendAction(AvatarAction.const_578);
            }
            if(_loc15_)
            {
               _loc6_.appendAction(AvatarAction.const_470);
            }
            _loc36_ = _loc4_.getNumber(RoomObjectVariableEnum.const_999);
            if(_loc36_ > 0)
            {
            ...
            _loc43_ = getSprite(const_1640);
            if(_loc4_.getNumber(RoomObjectVariableEnum.const_968))
            {
               _loc43_.visible = true;
               _loc40_ = null;
               _loc39_ = null;
               ...
               if(_loc39_ != null)
               {
                  _loc40_ = var_884.getAvatarRendererAsset(_loc39_) as BitmapDataAsset;
               }
               if(_loc40_ != null)
               {
                  _loc43_.asset = _loc40_.content as BitmapData;
            ...
            var_883.push(getTimer() - _loc23_);
            if(false)
            {
               _loc77_ = 0;
               _loc78_ = "[";
               for each(_loc79_ in var_883)
               {
                  _loc77_ += _loc79_;
                  _loc78_ += "," + _loc79_;
               }
