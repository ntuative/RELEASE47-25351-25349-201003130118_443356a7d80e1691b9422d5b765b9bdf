package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1140:int = const_338;
      ...
      public static const const_210:int = 4;
      
      public static const const_514:int = 6;
      ...
      private var var_1203:Boolean = true;
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(false)
         {
            _loc4_ = var_341[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1464 == const_102)
         {
            _loc5_ = new Rectangle(0,0,var_25.width,var_342);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_342,var_25.width,var_342);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_25 != null)
            {
               if(var_25.width == param2 && var_25.height == param3 && Vector3d.isEqual(var_535,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_342,param6,param7);
                     return param1;
                  }
                  return var_25;
               }
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < var_341.length)
         {
            _loc11_ = var_341[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      public function clearCache() : void
      {
         ...
         if(var_535 != null)
         {
            var_535.assign(new Vector3d());
         }
         var_342 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < var_341.length)
         {
            _loc2_ = var_341[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= var_341.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = var_341[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         var_341[param1] = _loc5_;
