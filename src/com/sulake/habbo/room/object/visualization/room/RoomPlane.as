package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         super();
         var_1931 = param8;
         var_833 = new Vector3d();
         var_833.assign(param1);
         var_73 = new Vector3d();
         ...
         var_487 = Vector3d.crossProduct(var_267,var_268);
         if(false)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_243 || _type == const_188))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_834 || false && false && !var_155 || var_576 == null)
         {
            return;
         }
         ...
         if(var_155)
         {
            ...
            while(_loc5_ < var_194.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_576.updateMask(var_57,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
            ...
            while(_loc6_ < var_261.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_1021.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_155 = false;
      ...
      {
         if(var_131 == null || var_101 == null || var_76 == null || var_102 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_243 || _type == const_188)
         {
      ...
      private function updateCorners(param1:IRoomGeometry) : void
      {
         ...
         var_101.assign(param1.getScreenPosition(Vector3d.sum(var_73,var_268)));
         var_76.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_73,var_267),var_268)));
         var_102.assign(param1.getScreenPosition(Vector3d.sum(var_73,var_267)));
         _offset = param1.getScreenPoint(var_833);
         ...
         var _loc2_:Number = Math.min(var_131.x,var_101.x,var_76.x,var_102.x);
         var _loc3_:Number = Math.max(var_131.x,var_101.x,var_76.x,var_102.x);
         var _loc4_:Number = Math.min(var_131.y,var_101.y,var_76.y,var_102.y);
         var _loc5_:Number = Math.max(var_131.y,var_101.y,var_76.y,var_102.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_131.x = 0 - _loc2_;
         var_101.x = 0 - _loc2_;
      ...
      public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : Boolean
      {
         ...
         if(param3)
         {
            ...
            _loc5_ = 0;
            while(_loc5_ < var_1183.length)
            {
               _loc4_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1183[_loc5_]));
               if(_loc4_ > -0.001)
               {
                  if(_isVisible)
                  {
            ...
            _loc6_ = param1.getScreenPosition(var_833);
            _loc7_ = _loc6_.z;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_684 != null)
            {
               _loc3_ = var_684.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1490,var_1928,var_1932,var_1933,var_1929,param2);
               if(_loc3_ != null)
               {
