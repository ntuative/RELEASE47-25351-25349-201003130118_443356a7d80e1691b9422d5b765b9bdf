package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1162:int = 13421772;
      
      private static const const_1132:int = 16777215;
      
      public static const const_1143:int = 10066329;
      
      private static const const_1129:int = 13421772;
      
      public static const const_1221:int = 16777215;
      
      private static const const_1433:int = 0;
      
      public static const const_1372:int = 16777215;
      
      private static const const_1130:int = 10066329;
      
      private static const const_1131:int = 10066329;
      
      public static const const_1289:int = 13421772;
       
      
      private var var_1438:int = 0;
      
      private var var_1195:String = null;
      
      private var var_2230:int = 255;
      ...
      private var var_1087:uint = 16777215;
      ...
      private var var_616:Rectangle = null;
      
      private var var_2232:int = 255;
      
      private var var_1772:Boolean = false;
      
      private var var_2233:int = 255;
      
      private var var_2234:String = null;
      
      private const const_1643:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         var_436 = new RoomPlaneBitmapMaskParser();
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_863);
         var _loc7_:int = 0;
         while(_loc7_ < var_79.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_147)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1221;
               }
               else
               {
                  _loc13_.color = const_1162;
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         if(var_616 == null)
         {
            var_616 = super.boundingRectangle;
         }
         return new Rectangle(var_616.x,var_616.y,var_616.width,var_616.height);
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         var _loc5_:int = 0;
         while(_loc5_ < var_436.maskCount)
         {
            _loc6_ = var_436.getMaskType(_loc5_);
            _loc7_ = var_436.getMaskLocation(_loc5_);
            _loc8_ = var_436.getMaskCategory(_loc5_);
            if(_loc7_ != null)
            {
               _loc9_ = 0;
               while(_loc9_ < var_104.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_243 || _loc3_.type == RoomPlane.const_188 && _loc8_ == RoomPlaneBitmapMaskData.const_213)
                  {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc13_.visible)
                  {
                     if(_loc11_)
                     {
                        ...
                        _loc13_.assetName = _loc14_ + "_" + var_1438;
                        if(var_79.getPlaneType(_loc9_) == RoomPlaneData.const_147)
                        {
      ...
      override public function update(param1:IRoomGeometry = null, param2:int = 0) : void
      {
         ...
         if(param1.updateId != var_1306)
         {
            ...
            if(_loc9_ != null && (_loc9_.x != var_1062 || _loc9_.y != var_2109 || _loc9_.z != var_2110 || param1.scale != var_2108))
            {
               var_1062 = _loc9_.x;
               var_2109 = _loc9_.y;
               var_2110 = _loc9_.z;
               var_2108 = param1.scale;
               _loc4_ = true;
            }
         }
         ...
         if(var_162 != _loc6_.getUpdateID())
         {
            ...
            {
               var_1087 = _loc11_;
               var_2233 = var_1087 & 255;
               var_2232 = var_1087 >> 8 & 255;
               var_2230 = var_1087 >> 16 & 255;
               _loc5_ = true;
            }
         }
         var _loc7_:int = param2;
         if(_loc7_ < var_1852 + const_1643 && !_loc4_ && !_loc5_)
         {
            return;
         }
         var_1852 = _loc7_;
         if(var_162 != _loc6_.getUpdateID())
         {
            _loc12_ = _loc6_.getString(RoomObjectVariableEnum.const_726);
            _loc13_ = _loc6_.getString(RoomObjectVariableEnum.const_671);
            _loc14_ = _loc6_.getString(RoomObjectVariableEnum.const_556);
            updatePlaneTextureTypes(_loc13_,_loc12_,_loc14_);
            var_2231 = Boolean(_loc6_.getNumber(RoomObjectVariableEnum.const_850));
            var_162 = _loc6_.getUpdateID();
         }
         updatePlanes(param1,_loc4_,param2);
         var _loc8_:int = 0;
         while(_loc8_ < var_435.length)
         {
            _loc15_ = 0;
            _loc16_ = getSprite(_loc15_);
            _loc17_ = var_435[_loc8_] as RoomPlane;
            if(_loc16_ != null && _loc17_ != null && _loc17_.type != RoomPlane.const_188)
            {
               if(var_2231)
               {
                  _loc18_ = uint(_loc17_.color);
                  _loc19_ = uint((_loc18_ & 255) * var_2233 / 255);
                  _loc20_ = uint((_loc18_ >> 8 & 255) * var_2232 / 255);
                  _loc21_ = uint((_loc18_ >> 16 & 255) * var_2230 / 255);
