package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1359:uint = 16777215;
      
      private var var_1091:uint = 16777215;
      
      protected var var_79:RoomPlaneParser = null;
      
      private var var_921:int = 0;
      
      private var var_1365:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_615:
                  _loc2_.setString(RoomObjectVariableEnum.const_671,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_570:
                  _loc2_.setString(RoomObjectVariableEnum.const_726,_loc3_.value);
                  break;
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_444:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_213)
                  {
                     _loc8_ = "null";
                  }
                  var_436.addMask(_loc4_.maskId,_loc4_.maskType,_loc4_.maskLocation,_loc8_);
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_559:
                  _loc7_ = var_436.removeMask(_loc4_.maskId);
            }
            if(_loc7_)
            {
               _loc9_ = var_436.getXML();
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_850,int(_loc5_.bgOnly));
            var_1359 = _color;
            var_1581 = var_1365;
            var_1091 = _loc11_;
            var_1582 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_883,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1248,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1249,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1379,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_140 || _loc13_ == RoomPlaneData.const_264)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(var_921)
         {
            ...
            {
               _loc7_ = var_1359 >> 16 & 255;
               _loc8_ = var_1359 >> 8 & 255;
               _loc9_ = var_1359 & 255;
               _loc10_ = var_1091 >> 16 & 255;
               _loc11_ = var_1091 >> 8 & 255;
               _loc12_ = var_1091 & 255;
