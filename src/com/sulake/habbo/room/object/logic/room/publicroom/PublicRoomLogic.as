package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_352,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_644,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_352,Number(false));
         var_846 = true;
      }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_964:
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_644,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_352,Number(true));
                  var_1069 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_961);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_358)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_644);
            ...
            case MouseEvent.ROLL_OUT:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_358)
               {
                  eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_330,_loc5_,_loc6_));
               }
         }
      }
   }
