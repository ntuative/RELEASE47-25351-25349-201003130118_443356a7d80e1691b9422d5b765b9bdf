package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_778:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1110:String = "tile_cursor";
      
      private static const const_279:int = -1;
       
      
      private var var_408:IRoomObjectVisualizationFactory = null;
      ...
      private var var_608:NumberBank;
      ...
      private var var_730:RoomMessageHandler = null;
      
      private var var_729:IRoomRendererFactory = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_314 = new Map();
         var_608 = new NumberBank(1000);
         var_1064 = new Map();
         var_315 = new Map();
         var_65 = new RoomObjectEventHandler(this);
         var_730 = new RoomMessageHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_65 != null)
         {
            ...
            {
               return var_65.deleteWallItem(var_116,var_115,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_697) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_565) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_713) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_665) + 0.5;
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_30)
            {
               return var_65.modifyWallItemData(var_116,var_115,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_408 != null)
         {
            var_408.release(new IIDRoomObjectVisualizationFactory());
            var_408 = null;
         }
         if(var_42 != null)
         {
         ...
         if(var_729 != null)
         {
            var_729.release(new IIDRoomRendererFactory());
            var_729 = null;
         }
         ...
         if(var_283)
         {
            var_283.release(new IIDHabboAdManager());
            var_283 = null;
         }
         _connection = null;
         if(var_608 != null)
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = var_729.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_901;
         ...
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_712);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_558);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_926);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_817);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_791) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_923);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_444,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_559,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_645,var_116,var_115,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_65 != null)
         {
            return var_65.modifyRoomObject(var_116,var_115,param1,param2,param3);
         }
         return false;
      }
      ...
      private function method_4(param1:Sprite, param2:String) : Sprite
      {
         var _loc4_:* = null;
         if(param1 == null)
         {
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_615,param3);
         ...
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_599,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_42 != null)
         {
            ...
            var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_66);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_65 != null)
         {
            var_65.handleRoomObjectEvent(param1,var_116,var_115);
         }
      }
      ...
      private function addOverlayIconSprite(param1:Sprite, param2:String, param3:BitmapData) : Sprite
      {
         ...
         var _loc4_:Sprite = method_4(param1,param2);
         if(_loc4_ != null)
         {
            return null;
         }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         {
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_227,_loc12_,true);
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_795,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_903,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_911,getTimer());
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.const_31));
         }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_735,param1,param2));
      }
      
      private function method_1() : void
      {
         if(var_28 == null || var_408 == null || var_42 == null || var_729 == null || _communication == null || _habboConfiguration == null || !var_2146)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_279,RoomObjectCategoryEnum.const_66);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1216,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_42.getRoom(getRoomIdentifier(var_116,var_115));
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_115,var_1318);
         if(_loc2_ != null)
         {
            _loc3_ = getOverlaySprite(_loc2_);
            _loc4_ = method_4(_loc3_,const_280);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_115,var_1318);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_408 = param2 as IRoomObjectVisualizationFactory;
         if(var_11 != null)
         {
            var_11.visualizationFactory = var_408;
         }
         method_1();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(var_28 != null)
         {
            if(false)
            {
               var_28.events.addEventListener(RoomObjectMouseEvent.const_214,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.const_356,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMouseEvent.ROOM_OBJECT_MOUSE_DOWN,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_261,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectStateChangeEvent.const_511,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectWidgetRequestEvent.const_92,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_451,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_432,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_361,roomObjectEventHandler);
               ...
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_373,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_392,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_474,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.const_480,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectFurnitureActionEvent.ROOM_OBJECT_JUKEBOX_DISPOSE,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectDimmerStateUpdateEvent.const_61,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_372,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectMoveEvent.const_389,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_272,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_406,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_331,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomAdEvent.const_330,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_478,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_978,roomObjectEventHandler);
               var_28.events.addEventListener(RoomObjectRoomActionEvent.const_378,roomObjectEventHandler);
               var_28.events.addEventListener(AvatarWalkWarpingWarningEvent.const_463,warningEventHandler);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_116,var_115);
         ...
         if(var_65 != null)
         {
            return var_65.initializeRoomObjectInsert(var_116,var_115,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_511 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_600,0,0));
            _loc2_ = 0;
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_503)
         {
            var_2146 = true;
            method_1();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_227,_loc10_,false);
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_901,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_276,param1,param2,param3,RoomObjectCategoryEnum.const_30));
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_283 = param2 as IAdManager;
         var_283.events.addEventListener(AdEvent.const_351,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_778) as Sprite;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_721,param1,param2));
      }
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_729 = param2 as IRoomRendererFactory;
         method_1();
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!var_511 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = var_42.getRoom(const_495);
         if(_loc10_ == null)
         {
            _loc10_ = var_42.createRoom(const_495,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = var_608.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.const_31:
            case RoomObjectCategoryEnum.const_30:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_227,int(param2));
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               break;
            case RoomObjectCategoryEnum.const_66:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_671,_loc18_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_726,_loc19_);
                     _loc13_.getModelController().setString(RoomObjectVariableEnum.const_556,_loc20_);
                     if(param6 != null)
                     {
                        _loc23_ = null;
                        _loc24_ = "undefined_" + _loc11_;
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_444,_loc24_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1064.add(String(_loc11_),param5);
            _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_898,param4,true);
         }
         else
         {
            _loc10_.disposeObject(_loc11_,_loc12_);
            var_608.freeNumber(_loc11_ - 1);
            _loc9_.id = 0;
         }
         _loc15_.dispose();
         return _loc9_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_780,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_115,param1);
         if(_loc9_ != null)
         {
            var_1318 = param1;
            var_1551 = param2;
            ...
            _loc11_ = method_4(_loc10_,const_280);
            if(_loc11_ != null)
            {
            ...
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_482,var_116,var_115,-1,RoomObjectCategoryEnum.const_229));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_65 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_279,const_494);
                  var_65.handleRoomObjectEvent(_loc14_,var_116,var_115);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_116,var_115,param1,param2,new Vector3d(),1,null);
         }
         else if(var_11 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_116,var_115,var_1318);
         if(_loc7_ != null)
         {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_11 != null)
         {
            ...
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_328,param1.image,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1007,param1.adWarningL,true);
            var_11.addGraphicAsset(var_11.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_919,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_964,RoomObjectVariableEnum.const_328,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_11 != null)
         {
            _events.addEventListener(RoomContentLoader.const_503,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_65 != null)
         {
            var_65.cancelRoomObjectInsert(var_116,var_115);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_42.getRoom(const_495);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_898);
               ...
               var_608.freeNumber(_loc10_ - 1);
               _loc13_ = var_1064.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_116,var_115,const_279,RoomObjectCategoryEnum.const_66,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_989,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_961,_loc13_,true);
            if(var_11 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_279,const_494,_loc8_) as IRoomObjectController;
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_697,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_713,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_565,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_665,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_863,_loc14_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_615,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
         ...
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_599,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_444,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_213);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_712,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_558,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_712,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_558,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_926,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_817,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_780,const_1110,RoomObjectCategoryEnum.OBJECT_CATEGORY_CURSOR);
