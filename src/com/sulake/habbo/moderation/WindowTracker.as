package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_504:int = 4;
      ...
      public static const const_1204:int = 8;
      
      public static const const_897:int = 5;
      
      public static const const_1159:int = 1;
      
      public static const const_1185:int = 2;
       
      
      private var var_1521:Dictionary;
      
      public function WindowTracker()
      {
         var_1521 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1521[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1521[param1] = _loc2_;
         }
         return _loc2_;
      }
