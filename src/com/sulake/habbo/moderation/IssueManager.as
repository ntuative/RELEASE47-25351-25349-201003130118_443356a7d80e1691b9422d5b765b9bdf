package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_841:String = "issue_bundle_open";
      
      public static const const_629:String = "issue_bundle_my";
      
      public static const const_797:String = "issue_bundle_picked";
      ...
      {
         var _loc2_:IssueHandler = var_1008.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in var_126)
         {
            ...
            {
               case const_841:
                  if(_loc4_.state == IssueMessageData.const_153)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var_145.remove(param1.issueId);
         var_145.add(param1.issueId,param1);
         var _loc2_:int = int(var_821.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_126)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_821.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_821.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_153)
         {
            ...
            _loc8_ = var_820.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1008.remove(param1);
         var_1008.add(param1,_loc3_);
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         var_820 = var_820.concat(param1);
      }
      
      public function method_9(param1:int, param2:int) : void
      {
      ...
      {
         var _loc2_:* = var_1008.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_153 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            var_56.soundManager.playSound(HabboSoundTypesEnum.const_950);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_821.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_126.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_381 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
