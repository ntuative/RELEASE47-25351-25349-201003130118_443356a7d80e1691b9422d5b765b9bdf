package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         _id = param1;
         var_145 = new Map();
         var_145.add(param2.issueId,param2);
         var_35 = param2.state;
         var_1620 = param2.pickerUserId;
         var_1621 = param2.pickerUserName;
         var_1011 = param2.reportedUserId;
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         ...
         var _loc1_:IssueMessageData = var_145.getWithIndex(0);
         var _loc3_:int = 1;
      ...
      {
         return var_145.remove(param1) as IssueMessageData;
      }
