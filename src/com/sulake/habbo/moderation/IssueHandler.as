package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_996:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var_399 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_996 = new UserInfoCtrl(_window,var_56,_loc3_.message);
         var_399.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_110.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_996.load(_loc4_,var_110.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.method_9(var_110.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_56,WindowTracker.const_834,_loc2_),_window,false,false,true);
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.method_9(var_110.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_56.issueManager.method_9(var_110.id,3);
         checkAutoHandling();
         dispose();
      }
