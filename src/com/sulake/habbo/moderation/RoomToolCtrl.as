package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_941:ICheckBoxWindow;
      ...
      private var var_942:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _main.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),_main,WindowTracker.const_504,_data.flatId),var_51,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_427);
         if(param1.flatId != var_427)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_427);
            return;
         }
         _data = param1;
         populate();
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_630.isSelected);
         _main.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1359,_loc2_,var_418.text,"",""));
         if(false)
         {
            _main.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_941.isSelected,var_942.isSelected,var_630.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1184);
      }
      ...
      public function populate() : void
      {
         ...
         var_757 = IDropMenuWindow(var_51.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_757);
         var_757.procedure = onSelectTemplate;
         var_630 = ICheckBoxWindow(var_51.findChildByName("kick_check"));
         var_941 = ICheckBoxWindow(var_51.findChildByName("lock_check"));
         var_942 = ICheckBoxWindow(var_51.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         _main.connection.send(new GetModeratorRoomInfoMessageComposer(var_427));
         Logger.log("BEGINNING TO SHOW: " + var_427);
      }
   }
}
