package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1456:IIssueBrowserView;
      
      private const const_1634:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1633:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1454:IIssueBrowserView;
      
      private const const_1644:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1632:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_223:ITabContextWindow;
      
      private var var_1455:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_339.view.width = var_223.container.width;
         var_339.view.height = var_223.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1632:
               if(var_1454 == null)
               {
                  var_1454 = new MyIssuesView(issueManager,this,var_223.container);
               }
               return var_1454;
            case const_1634:
               if(var_1456 == null)
               {
                  var_1456 = new OpenIssuesView(issueManager,this,var_223.container);
               }
               return var_1456;
            case const_1633:
               if(var_1455 == null)
               {
                  var_1455 = new PickedIssuesView(issueManager,this,var_223.container);
               }
               return var_1455;
            default:
               return null;
