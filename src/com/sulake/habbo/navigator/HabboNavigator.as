package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2361:Dictionary;
      ...
      private var var_783:ISessionDataManager;
      
      private var var_782:RoomCreateViewCtrl;
      
      private var var_1688:RoomThumbnailRenderer;
      
      private var var_182:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_553:RoomInfoViewCtrl;
      
      private var _catalog:IHabboCatalog;
      
      private var var_380:Tabs;
      
      private var var_248:MainViewCtrl;
      
      private var var_1704:Array;
      
      private var var_1076:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_248 = new MainViewCtrl(this);
         var_553 = new RoomInfoViewCtrl(this);
         var_782 = new RoomCreateViewCtrl(this);
         var_1688 = new RoomThumbnailRenderer(this);
         var_1076 = new GuestRoomPasswordInput(this);
         _doorbell = new GuestRoomDoorbell(this);
         var_380 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_248.startSearch(Tabs.const_193,Tabs.const_298,param1);
         var_248.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_182 != null)
         {
            var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_783)
         {
            var_783.release(new IIDSessionDataManager());
            var_783 = null;
         }
         if(_catalog)
         {
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_182 != null)
         {
            var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_783 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_248.startSearch(Tabs.const_250,Tabs.const_221);
         var_380.getTab(Tabs.const_250).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_248.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
