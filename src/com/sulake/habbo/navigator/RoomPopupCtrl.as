package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_107:GuestRoomData;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1688 = new RoomThumbnailRenderer(param1);
         var_842 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_167,var_107.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_842.refreshTags(_loc1_,var_107.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1688.refreshThumbnail(_loc1_,var_107.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_167,var_107);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_167,!true ? getEventCtg(var_107.categoryId) : getRoomCtg(var_107.categoryId));
         refreshRoomDesc(var_167,var_107);
         refreshExtraCont();
         refreshInfo(var_167,"trading_allowed",var_107.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_193,Tabs.const_209,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
