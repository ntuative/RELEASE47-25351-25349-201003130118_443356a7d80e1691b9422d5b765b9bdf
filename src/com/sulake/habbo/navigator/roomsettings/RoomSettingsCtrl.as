package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1333:TextFieldManager;
      ...
      private var var_1567:IWindowContainer;
      ...
      private var var_1331:TextFieldManager;
      ...
      private var var_1337:ICheckBoxWindow;
      ...
      private function populateForm() : void
      {
         ...
         var_909.setText(_loc1_.name);
         var_1331.setText(_loc1_.description);
         var_1076.setText("");
         var_1333.setText("");
         ...
         setTag(var_777,_loc1_.tags[0]);
         setTag(var_776,_loc1_.tags[1]);
         if(var_1337)
         {
            if(_loc1_.allowPets)
            {
               this.var_1337.select();
            }
            else
            {
               this.var_1337.unselect();
            }
         }
         if(var_1335)
         {
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_427);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_87.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_427]);
         _loc2_.show();
      }
      ...
      {
         var _loc10_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(var_281.findChildByName("flat_controller_list"));
         var _loc2_:IButtonWindow = IButtonWindow(var_281.findChildByName("remove_flat_ctrl"));
         var _loc3_:IButtonWindow = IButtonWindow(var_281.findChildByName("remove_all_flat_ctrls"));
         var _loc4_:IWindow = var_281.findChildByName("flat_ctrls_caption_txt");
         var _loc5_:IWindow = var_281.findChildByName("flat_ctrls_info_txt");
         var _loc6_:IWindow = var_281.findChildByName("flat_ctrls_limit_txt");
         var _loc7_:IWindowContainer = IWindowContainer(var_281.findChildByName("flat_controllers_footer"));
         Util.hideChildren(var_281);
         var_281.findChildByName("ruler").visible = true;
         ...
         if(var_87.controllers.length > 0)
         {
            ...
            Util.moveChildrenToColumn(var_281,["flat_ctrls_caption_txt","flat_ctrls_limit_txt","flat_controller_list","flat_ctrls_info_txt","flat_controllers_footer"],_loc4_.y,5);
         }
         else
         {
         ...
         var_281.height = Util.getLowestPoint(var_281);
      }
      
      private function getFlatControllerContainer(param1:String) : IWindowContainer
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_56,HabboWindowStyle.const_38,HabboWindowParam.const_68,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1567.visible = _inRoom;
         var_1566.visible = _inRoom;
         var_2185.visible = var_513;
         var_2184.visible = !var_513;
         if(var_513)
         {
         ...
         else
         {
            ...
            var_1334.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1334.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_1073.height = Util.getLowestPoint(this.var_1073) + 4;
         }
         var_1565.text = !!var_513 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1567.name,var_1334.name,var_1073.name,var_1074.name,var_1336.name,var_1566.name],0,0);
      ...
      {
         this.var_427 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_427));
         if(var_1077 != null)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = var_909.getText();
         _loc2_.description = var_1331.getText();
         ...
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_122)
         {
            ...
            _loc9_ = var_1333.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1076.clearErrors();
               this.var_1333.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1337.isSelected;
         _loc2_.allowFoodConsume = var_1335.isSelected;
         _loc2_.allowWalkThrough = var_1332.isSelected;
         _loc2_.tags = new Array();
         addTag(var_777,_loc2_.tags);
         addTag(var_776,_loc2_.tags);
         this.clearErrors();
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_427));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_427 || var_1075 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_909.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1376)
         {
            this.var_909.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1142)
         {
            this.var_1331.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1326)
         {
            ...
            setTagError(this.var_776,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1319)
         {
            ...
            setTagError(this.var_776,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         ...
         {
            this.var_909.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_705,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_1017,onDoorModePasswordUnselect);
         ...
         this.var_909 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1331 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_777 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_776 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_1076 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1333 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1337 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1335 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1332 = ICheckBoxWindow(_window.findChildByName("allow_walk_through_checkbox"));
         var_1567 = IWindowContainer(_window.findChildByName("header_container"));
         var_1334 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         ...
         var_1566 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1336 = IWindowContainer(_window.findChildByName("footer_container"));
         var_281 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_1077 = IWindowContainer(_window.findChildByName("password_container"));
         var_2184 = ITextWindow(_window.findChildByName("basic_caption"));
         var_2185 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1565 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1565.procedure = onSwitchView;
         var_1077.visible = false;
         if(!_inRoom)
         {
