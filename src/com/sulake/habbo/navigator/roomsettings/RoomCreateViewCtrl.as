package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_832:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_486 = new Timer(100);
         var_486.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_44 = new Array();
         ...
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_145,80,"g"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_145,74,"h"));
         ...
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_145,416,"o"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_145,352,"p"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_145,304,"q"));
         var_44.push(new RoomLayout(HabboClubLevelEnum.const_145,336,"r"));
      ...
      private function prepare() : void
      {
         ...
         var_1020 = new TextFieldManager(_navigator,ITextFieldWindow(var_21.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function addThumbnail(param1:IWindowContainer, param2:RoomLayout, param3:Boolean) : void
      {
         ...
         if(param2.requiredClubLevel == HabboClubLevelEnum.const_145)
         {
            _loc8_ = "hc_only";
         }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_1020.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1917 = _navigator.data.hcMember;
      }
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            case HabboClubLevelEnum.const_75:
               return true;
            case HabboClubLevelEnum.const_145:
      ...
      public function dispose() : void
      {
         if(var_486)
         {
            var_486.removeEventListener(TimerEvent.TIMER,updateArrowPos);
            var_486.reset();
            var_486 = null;
         }
      }
      ...
      {
         var_1020.goBackToInitialState();
         var_1020.input.textBackgroundColor = 4294967295;
         var_832 = var_44[0];
         if(var_1917 != _navigator.data.hcMember)
         {
      ...
      {
         var _loc1_:Boolean = var_1020.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_832.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1234 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1234 = true;
            _loc3_.y = 1;
