package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1813 = this._navigator.getButtonImage(this.var_1812);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1814 == null)
         {
            ...
            this.var_1814 = new Rectangle(var_1443,var_1443,_loc1_.width - 2 * var_1443,_loc1_.height - 2 * var_1443);
         }
         var_663.bitmap.fillRect(var_663.bitmap.rect,4281545523);
         var_663.bitmap.fillRect(this.var_1814,4284900966);
         copyTo(var_663.bitmap);
         if(_selected)
         {
            var_663.bitmap.copyPixels(var_1811,var_1811.rect,new Point(0,0),null,null,true);
         }
         var_663.invalidate();
      }
