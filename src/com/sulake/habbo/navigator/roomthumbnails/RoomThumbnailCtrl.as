package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private function refreshTab() : void
      {
         ...
         setEnabled(var_1506,this._model.mode != ThumbnailEditorModel.const_54);
         setEnabled(var_1505,this._model.mode != ThumbnailEditorModel.const_34);
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1506 = IButtonWindow(find("top_tab"));
         var_1505 = IButtonWindow(find("obj_tab"));
         var_2001 = IWindowContainer(find("tile_grid"));
         var_2000 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1506,onTopTabButton);
         Util.setProcDirectly(var_1505,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_2001;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_459)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_2000;
      ...
      private function method_11(param1:IWindowContainer) : void
      {
         var _loc3_:int = 0;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_56,HabboWindowStyle.const_38,HabboWindowParam.const_68,new Rectangle(0,0,param1.width,66)));
