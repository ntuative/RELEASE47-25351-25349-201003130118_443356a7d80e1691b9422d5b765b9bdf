package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1057:int = 8;
      
      public static const const_459:int = 10;
      
      private static const const_1056:int = 40;
      ...
      private var var_802:ThumbnailImageConfigurations;
      
      private var var_1187:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_981 = new Dictionary();
         super();
         _navigator = param1;
         var_802 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_802.getImage(ThumbnailEditorModel.const_34,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1058,_loc4_.y + const_1056 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1766[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_802.getImage(ThumbnailEditorModel.const_37,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_802.getImage(ThumbnailEditorModel.const_37,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_802.getImage(ThumbnailEditorModel.const_54,param2);
         if(_loc3_ == null)
         {
      ...
      private function getLoc(param1:int, param2:int) : Point
      {
         ...
         return new Point(param1 * const_749 + _loc3_,param2 * const_1057);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_459)
         {
            if(false)
            {
               refreshObj(param1,var_981[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1187 == null)
         {
            var_1187 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1187,var_1187.rect,new Point(0,0),null,null,true);
      }
   }
}
