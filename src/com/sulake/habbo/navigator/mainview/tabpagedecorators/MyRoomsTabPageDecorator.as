package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2384:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_610;
         }
         if(param1 == 2)
         {
            return Tabs.const_543;
         }
         if(param1 == 3)
         {
            return Tabs.const_545;
         }
         if(param1 == 4)
         {
      ...
      {
         var _loc1_:int = var_515 == null ? 0 : int(var_515.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         _navigator.mainViewCtrl.startSearch(Tabs.const_250,getSearchTypeForIndex(_loc1_));
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_515 == null)
         {
            var_515 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_515.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
