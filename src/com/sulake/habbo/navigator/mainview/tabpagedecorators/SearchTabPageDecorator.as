package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1572:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_193,Tabs.const_209,"-1",MainViewCtrl.const_536);
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1572 == null)
         {
            ...
            var_1572 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1572.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
