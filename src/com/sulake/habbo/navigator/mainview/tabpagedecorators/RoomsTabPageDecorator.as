package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_256,Tabs.const_326);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_256,Tabs.const_601);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_256,Tabs.const_326,"" + _loc3_);
         }
      }
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_458 == null)
         {
            var_458 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
            var_458.procedure = onChangeFilter;
