package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1073:uint = 1;
      ...
      private var var_673:IWindowRenderer;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_673 = new WindowRenderer(_loc4_);
         var_226 = new Array(const_343);
         var _loc6_:int = 0;
         while(_loc6_ < const_343)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_673,this,_localization,context.displayObjectContainer,new Rectangle(0,0,context.displayObjectContainer.stage.stageWidth,context.displayObjectContainer.stage.stageHeight),this);
            var_226[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_235 = var_226[const_1073];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_235.getMouseCursor().defineCustomCursorType(MouseCursorType.const_325,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_235.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1316,_loc7_);
      }
      ...
      {
         return var_226[param1].getDesktopWindow().getChildAt(var_235.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1206 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1206 = new ProfilerOutput(_loc3_,this,var_673);
               var_1209 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1209);
               var_1207 = new ProfilerAgentTask("Redraw","Window rasterizer");
      ...
      {
         var _loc3_:Dictionary = var_402[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_402[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1321,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1338,param2.name + ": " + param2.toString());
            }
