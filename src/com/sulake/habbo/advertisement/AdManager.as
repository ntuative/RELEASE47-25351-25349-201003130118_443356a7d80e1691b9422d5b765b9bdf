package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_792:BitmapData = null;
      ...
      private var var_793:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_351,0,0,_loc4_,var_1427,var_793,var_792));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1729 = int(_config.getKey("interstitial.interval","30000"));
         var_1730 = int(_config.getKey("interstitial.show.time","5000"));
         var_1426 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1172 = _loc2_.imageUrl;
         var_1427 = _loc2_.clickUrl;
         if(var_1172 != "" && var_1427 != "")
         {
            _loc3_ = var_1172;
            ...
            _loc4_ = new URLRequest(var_1172);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1171 = _loc2_.imageUrl;
         var_1728 = _loc2_.clickUrl;
         var_650 = getTimer();
         if(var_1171 != "")
         {
            _loc3_ = var_1171;
            ...
            if(var_218 == null)
            {
               var_218 = new Timer(var_1730,1);
               var_218.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_218.reset();
            ...
            var_218.start();
            _loc4_ = new URLRequest(var_1171);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_469,0,0,param1.bitmapData,var_1728));
            var_650 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_792 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1426 > 0 && var_1425 >= var_1426)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_650;
         if(_loc1_ > var_1729)
         {
            ++var_1425;
      ...
      {
         var_297 = param2 as IHabboCommunicationManager;
         if(var_297 == null)
         {
            return;
         }
         _connection = var_297.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.include));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_793 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
