package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_538:Conversations;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_293:MessengerView;
      ...
      {
         var _loc2_:Conversation = var_538.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_538.setSelected(_loc2_);
            var_293.openMessenger();
            var_293.refresh(true);
         }
      }
      ...
      {
         var_538.addMessageAndUpdateView(param1);
         if(!var_293.isMessengerOpen())
         {
      ...
      {
         var_538 = new Conversations(new ConversationsDeps(this));
         var_293 = new MessengerView(this);
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_124,HabboToolbarIconEnum.MESSENGER));
      ...
      {
         var_538.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_730,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_538.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var_538.addMessageAndUpdateView(_loc3_);
      }
