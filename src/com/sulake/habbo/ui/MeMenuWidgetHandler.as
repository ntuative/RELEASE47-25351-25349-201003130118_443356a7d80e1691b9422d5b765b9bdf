   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_902,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_537,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_418,onHelpTutorialEvent);
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_537,onFigureUpdate);
         ...
         if(var_10 != null)
         {
            (var_10 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1018,method_13);
            (var_10 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_812,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_418,onHelpTutorialEvent);
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_103:
               ...
               break;
            case HabboHelpTutorialEvent.const_418:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_481));
         }
      }
      ...
      private function method_13(param1:Event = null) : void
      {
         var _loc2_:* = null;
         if(_container == null)
         {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_521);
         _loc1_.push(RoomWidgetDanceMessage.const_520);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_709);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_691);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_690);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_632);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_725);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_542);
         _loc1_.push(RoomWidgetStopEffectMessage.const_563);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1222);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_829);
         _loc1_.push(RoomWidgetToolbarMessage.const_647);
         _loc1_.push(RoomWidgetToolbarMessage.const_583);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_694);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1178);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_803);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_619);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_577);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_624);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_592);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1170);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_608);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_519);
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_611));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_577:
               ...
               break;
            case RoomWidgetWaveMessage.const_521:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_520:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_709:
               if(var_10 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_691:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_690:
               if(var_10 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_542:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(_catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_657)
               {
                  _catalog.openCatalogPage(CatalogPageName.const_244,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_725:
               ...
               if(var_10 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     ...
                     case RoomWidgetOpenInventoryMessage.const_836:
                        var_10.toggleInventoryPage(InventoryCategory.const_254);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1365:
                        var_10.toggleInventoryPage(InventoryCategory.const_76);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1339:
                        break;
                     default:
            ...
            case RoomWidgetStopEffectMessage.const_563:
            ...
            case RoomWidgetNavigateToRoomMessage.const_829:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_619:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_647:
               ...
               if(var_182)
               {
                  var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_10 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_583:
               ...
               if(var_182 && false)
               {
                  var_182.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_380,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_694:
               ...
               if(_container)
               {
                  ...
                  if(false && _loc23_ == HabboClubLevelEnum.const_75)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_386,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_857));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_386,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1389));
                     }
                  }
                  if(false && _container.habboHelp.events)
                  {
                     _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_731));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_624:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_592:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_333,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_608:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_333,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_519:
            ...
            case RoomWidgetAvatarEditorMessage.const_685:
               if(false && _container.habboHelp.events)
               {
                  _container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_650));
               }
               break;
            default:
