package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_164:DesktopLayoutManager;
      ...
      private var var_917:IHabboHelp = null;
      ...
      private var var_762:IRoomWidgetFactory = null;
      ...
      private var var_1614:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_183 = new Map();
         var_164 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_307,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_434,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_668,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_632 = _roomEngine.loadRoomResources(var_39.roomResources);
            if(false)
            {
               var_1122 = false;
         ...
         {
            var_1121 = !var_283.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_39.roomId,var_39.roomCategory,var_244[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_307,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_434,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_668,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_20 = null;
         var_762 = null;
         ...
         if(var_182 && false)
         {
            ...
            var_182.events.removeEventListener(HabboToolbarEvent.const_57,onHabboToolbarEvent);
         }
         var_182 = null;
         _localization = null;
         _config = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1614);
      ...
      {
         var_164.setLayout(param1,_windowManager);
         if(var_182 != null)
         {
            var_164.toolbarSize = var_182.size;
            var_164.toolbarOrientation = var_182.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_762.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_164.addWidgetWindow(_loc2_.mainWindow);
         ...
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_164.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_164 != null)
         {
            var_164.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_605:
               ...
               if(var_746 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_39.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_383)
                  {
                     var_746.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_431:
               ...
               break;
            case RoomEngineObjectEvent.const_371:
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_164.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_697);
            _loc13_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_713);
            _loc14_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_565);
            _loc15_ = _roomEngine.getRoomNumberValue(var_39.roomId,var_39.roomCategory,RoomVariableEnum.const_665);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_371:
               ...
               var_163 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_329,WindowStyle.const_313,WindowParam.const_84) as IToolTipWindow;
               var_163.setParamFlag(WindowParam.const_50,false);
      ...
      {
         if(var_632 == null || false)
         {
            return;
         }
         var _loc2_:int = var_632.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_632.splice(_loc2_,1);
         }
         if(false)
         {
            var_1122 = true;
      ...
      {
         if(var_20 != null && var_39 != null && var_1121 && var_1122)
         {
            var_20.startSession(var_39);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_236));
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_164.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
