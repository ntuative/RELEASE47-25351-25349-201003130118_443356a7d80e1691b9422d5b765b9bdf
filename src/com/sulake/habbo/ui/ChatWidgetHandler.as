   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         ...
         if(var_506 != null)
         {
            ...
            {
               _loc2_ = var_506.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_506.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_719.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_297:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_506.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_719.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_573,RoomWidgetChatSelectAvatarMessage.const_548];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_573:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_143,_container.roomSession,0,"Version 25351-25349-201003130043");
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_548:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_878 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_878);
            }
            if(var_505 == null)
            {
               var_507.x = 0;
               var_507.y = 0;
               var_507.z = 0;
               var_505 = _loc4_.getScreenPoint(var_507);
               var_878 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_507.x = 0;
            var_507.y = 0;
            var_507.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_507);
            if(_loc8_ != null)
            {
