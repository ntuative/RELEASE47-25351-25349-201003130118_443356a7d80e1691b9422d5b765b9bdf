package com.sulake.habbo.ui
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_541);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_623);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_524);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_541:
            ...
            case RoomWidgetFriendRequestMessage.const_623:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_524:
