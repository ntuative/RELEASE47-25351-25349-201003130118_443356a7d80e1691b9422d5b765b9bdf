package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_513,RoomWidgetEcotronBoxOpenMessage.const_649,RoomWidgetEcotronBoxOpenedMessage.const_1283];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_513:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_649:
