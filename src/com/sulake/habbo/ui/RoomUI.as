package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_283:IAdManager;
      
      private var var_762:IRoomWidgetFactory;
      ...
      private var var_746:IHabboModeration;
      ...
      private var var_917:IHabboHelp;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = var_762;
         ...
         _loc3_.adManager = var_283;
         _loc3_.localization = _localization;
         _loc3_.habboHelp = var_917;
         _loc3_.moderation = var_746;
         _loc3_.config = _config;
         _loc3_.soundManager = var_489;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_489 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_105:
               if(param1.session != null)
               {
                  ...
                  var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.ZOOM));
                  var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.MEMENU));
                  var_182.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_283 != null && false)
         {
            var_283.events.addEventListener(AdEvent.include,adEventHandler);
            var_283.events.addEventListener(AdEvent.const_469,adEventHandler);
            var_283.events.addEventListener(AdEvent.const_351,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_762 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_762 != null)
         {
            var_762.release(new IIDHabboRoomWidget());
            var_762 = null;
         }
         if(var_10 != null)
         {
         ...
         if(var_489 != null)
         {
            var_489.release(new IIDHabboSoundManager());
            var_489 = null;
         }
         if(var_283 != null)
         {
         ...
         if(var_917 != null)
         {
            var_917.release(new IIDHabboHelp());
            var_917 = null;
         }
         ...
         if(var_746 != null)
         {
            var_746.release(new IIDHabboModeration());
            var_746 = null;
         }
         if(_navigator != null)
         {
         ...
         if(var_284)
         {
            while(false)
            {
               _loc1_ = var_284.getKey(0) as String;
               _loc2_ = var_284.remove(_loc1_) as RoomDesktop;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:RoomDesktop = var_284.remove(param1) as RoomDesktop;
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getWidgetState(RoomWidgetEnum.const_246);
            if(_loc3_ != RoomDesktop.const_661)
            {
               var_1575 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_746 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_746);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            _loc3_ = var_284.getWithIndex(_loc2_) as RoomDesktop;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_735:
               _loc5_ = false;
               ...
               if(var_1575 != RoomDesktop.const_661)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_246,var_1575);
               }
               if(var_283 != null)
               {
                  var_283.showRoomAd();
               ...
               break;
            case RoomEngineEvent.const_721:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_212:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_509:
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomEngineEvent.const_600,roomEngineEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_735,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_721,roomEventHandler);
      ...
      private function registerSessionEvents() : void
      {
         if(var_20)
         {
            var_20.events.addEventListener(RoomSessionEvent.const_283,roomSessionStateEventHandler);
            var_20.events.addEventListener(RoomSessionEvent.const_90,roomSessionStateEventHandler);
            var_20.events.addEventListener(RoomSessionEvent.const_105,roomSessionStateEventHandler);
            var_20.events.addEventListener(RoomSessionChatEvent.const_143,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionUserBadgesEvent.const_116,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDoorbellEvent.const_104,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDoorbellEvent.const_128,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDoorbellEvent.const_55,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPresentEvent.const_275,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_192,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_217,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_554,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_807,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_821,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_205,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_231,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_215,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_226,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_198,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_212,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_223,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_509,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_620,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_160,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_708,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionErrorMessageEvent.const_658,roomSessionDialogEventHandler);
            var_20.events.addEventListener(RoomSessionQueueEvent.const_416,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionVoteEvent.const_112,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionVoteEvent.const_108,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPollEvent.const_120,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPollEvent.const_60,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionPollEvent.const_121,roomSessionEventHandler);
            var_20.events.addEventListener(RoomSessionDimmerPresetsEvent.const_370,roomSessionEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_600)
         {
            if(var_20 != null)
            {
               var_20.roomEngineReady = true;
      ...
      {
         return var_284.getValue(param1) as RoomDesktop;
      }
