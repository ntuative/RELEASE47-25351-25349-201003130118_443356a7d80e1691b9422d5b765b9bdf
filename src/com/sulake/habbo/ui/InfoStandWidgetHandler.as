   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            ...
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_154,onFigureUpdate);
         ...
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_154,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_30:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_516);
               _loc6_.id = param1.id;
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_903);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_911);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_297)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_383)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_940)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_530);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_207)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_507);
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_921;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_973;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1385);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_565.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_52);
            var_565.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_507);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_303);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_235);
         _loc1_.push(RoomWidgetFurniActionMessage.const_677);
         _loc1_.push(RoomWidgetFurniActionMessage.const_719);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_517);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_534);
         _loc1_.push(RoomWidgetUserActionMessage.const_353);
         _loc1_.push(RoomWidgetUserActionMessage.const_672);
         _loc1_.push(RoomWidgetUserActionMessage.const_562);
         _loc1_.push(RoomWidgetUserActionMessage.const_1219);
         _loc1_.push(RoomWidgetPetCommandMessage.const_498);
      ...
      public function dispose() : void
      {
         ...
         if(var_565 != null)
         {
            _loc1_ = var_565.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_565.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_353)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_303:
            ...
            case RoomWidgetUserActionMessage.const_564:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_853,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_384:
               _container.roomSession.method_15(_loc3_.webID);
               break;
            ...
            case RoomWidgetUserActionMessage.const_402:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_517:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_534:
               ...
               break;
            case RoomWidgetUserActionMessage.const_353:
            ...
            case RoomWidgetPetCommandMessage.const_597:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_498:
