package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_770:uint = 4284532064;
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            var_352.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_414);
            var_352.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_175)
            {
               var_175.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_175.stop();
               var_175 = null;
            }
            if(var_352 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1533 == null)
         {
            var_1533 = createMinimizedWindow();
         }
         if(!var_2083)
         {
            return var_63;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_175 == null)
         {
            var_175 = new Timer(1000,3);
            var_175.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_175.reset();
         var_175.repeatCount = 3;
         var_175.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_63)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_770) : uint(const_769);
            }
