package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         ...
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_1460,var_1461);
         }
      }
      ...
      {
         if(param1 != var_1668 || param2 != var_1664)
         {
            return;
         }
         if(!_view)
         ...
         _view.updateAveragePrice(param3,var_1667);
      }
      ...
      {
         if(var_13 != null && false && var_224 != null)
         {
            var_13.furniModel.removeLockFrom(var_224.id);
            var_224 = null;
         }
      }
