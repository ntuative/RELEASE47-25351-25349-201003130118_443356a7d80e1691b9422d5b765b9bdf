package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      {
         return var_499.removeGridItemAt(param1);
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_29 && var_351 != null && var_351 == param2 && true)
         {
         ...
         else if(param1.type == WindowMouseEvent.const_248)
         {
