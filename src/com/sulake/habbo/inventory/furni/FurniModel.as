package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         _assets = param5;
         _roomEngine = param6;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_194,onObjectPlaced);
         var_504 = new Timer(const_1094,1);
         var_504.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return var_13.getSubCategoryViewId() == InventorySubCategory.const_245;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_420.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_420.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_664)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_194,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_504 != null)
            {
               var_504.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_504.stop();
               var_504 = null;
            }
            if(var_139 != null)
            {
               var_139.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_139.stop();
               var_139 = null;
            }
            if(var_717 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_312)
         {
         ...
         else if(param3 == FurniCategory.const_306)
         {
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_245:
               ...
               break;
            case InventorySubCategory.const_789:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_139 = new Timer(param1,1);
            var_139.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_139.start();
         }
         else
         {
      ...
      {
         var_13.checkCategoryInitilization(InventoryCategory.const_461);
         ...
         if(param1 == InventoryCategory.const_76 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_43:
                  ...
                  break;
               case const_332:
                  var_13.toggleInventoryPage(InventoryCategory.const_137);
            }
         }
      }
      ...
      {
         if(var_876 && param1.type == RoomEngineObjectEvent.const_194)
         {
            var_13.showView();
            var_876 = false;
         }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_306 || _loc3_.category == FurniCategory.const_312 || _loc3_.category == FurniCategory.const_315)
         {
            if(param1)
            {
               return false;
      ...
      {
         var_420 = new Map();
         var_420.add(const_42,new Array());
         var_420.add(const_43,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
