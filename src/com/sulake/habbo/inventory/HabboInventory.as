package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_852:IRoomSession;
      ...
      override public function dispose() : void
      {
         ...
         if(var_20 != null)
         {
            var_20.events.removeEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
            var_20.events.removeEventListener(RoomSessionEvent.const_105,roomSessionEventHandler);
            var_20.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_409,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_105:
               var_852 = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_409:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_48.getValue(InventoryCategory.const_722));
      }
      ...
      {
         var_156.clubPeriods = param1;
         var_156.clubDays = param2;
         var_156.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_48.getValue(InventoryCategory.const_137));
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1018));
      }
      ...
      {
         return AchievementsModel(var_48.getValue(InventoryCategory.const_323));
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_245:
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_851.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_851.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_48.getValue(InventorySubCategory.const_245));
      }
      ...
      {
         return var_156.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_48.getValue(InventoryCategory.const_461) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1036 = new IncomingMessages(this);
      ...
      {
         return var_156.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_156.clubPastPeriods;
      }
      ...
      {
         return BadgesModel(var_48.getValue(InventoryCategory.const_254));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_20.events.addEventListener(RoomSessionEvent.const_90,roomSessionEventHandler);
         var_20.events.addEventListener(RoomSessionEvent.const_105,roomSessionEventHandler);
         var_20.events.addEventListener(RoomSessionPropertyUpdateEvent.const_409,roomSessionEventHandler);
         ...
         var_48.add(InventoryCategory.const_461,_loc3_);
         ...
         var_48.add(InventoryCategory.const_137,_loc10_);
