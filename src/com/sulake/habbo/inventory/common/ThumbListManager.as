package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_548 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_548.width;
         var_91 = var_548.height;
         var_960 = param5;
         var_774 = param6;
         var_213 = Math.floor(var_960 / _thumbWidth);
         var_19 = new BitmapData(var_960,var_774);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(param1.y < var_454 - 1)
         {
            ...
            var_19.fillRect(new Rectangle(0,0 - var_91,var_19.width,var_91),4294967295);
         ...
         if(_loc6_ > 0)
         {
            ...
            {
               _loc11_ = new BitmapData(var_19.width,0 - var_91);
               _loc2_ = new Rectangle(0,0,var_19.width,0 - var_91);
               _loc11_.copyPixels(var_19,_loc2_,new Point(0,0),null,null,true);
               var_19 = _loc11_;
               --var_454;
            }
         }
         if(var_19.height < var_774)
         {
            _loc12_ = new BitmapData(var_19.width,var_774);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_548.width,var_548.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_548.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_548,var_548.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      public function updateImageFromList() : void
      {
         ...
         var_19 = new BitmapData(Math.max(var_213 * _thumbWidth,var_960),Math.max(var_454 * var_91,var_774),true,16777215);
            ...
            while(_loc4_ < var_213)
            {
               if(_loc1_ < _loc2_.length)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     var_19.copyPixels(_loc6_,_loc6_.rect,new Point(_loc4_ * _thumbWidth,_loc3_ * var_91),null,null,true);
                  }
                  _loc1_++;
               }
               _loc4_++;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_213 && var_19.height < _loc3_.y * var_91)
         {
            _loc2_ = new BitmapData(var_19.width,var_19.height + var_91);
         }
         else
         {
         ...
         _loc4_ = new Rectangle(_thumbWidth * (var_213 - 1),0,_thumbWidth,var_19.height);
         _loc2_.copyPixels(var_19,_loc4_,new Point(0,var_91),null,null,true);
         _loc4_ = new Rectangle(0,var_91,_thumbWidth * (var_213 - 1),0 - var_91);
         _loc2_.copyPixels(var_19,_loc4_,new Point(_thumbWidth,var_91),null,null,true);
         var_19 = _loc2_;
      }
