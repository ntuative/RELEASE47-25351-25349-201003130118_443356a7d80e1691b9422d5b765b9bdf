package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_929:Boolean;
      
      protected var var_2264:Boolean;
      
      protected var var_1755:int;
      ...
      private const const_1620:int = 8947848;
      
      protected var _items:Map;
      
      protected var _category:int;
      
      protected var var_367:BitmapData;
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(category == FurniCategory.const_664)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < _items.length)
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = _roomEngine.getFurnitureIcon(_type,this,String(var_1439));
         }
         else
         {
            _loc1_ = _roomEngine.getWallItemIcon(_type,this,var_1379);
         }
         if(_loc1_.id > 0)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc5_)
         {
            if(var_1370 && getRecyclableCount() > 0)
            {
