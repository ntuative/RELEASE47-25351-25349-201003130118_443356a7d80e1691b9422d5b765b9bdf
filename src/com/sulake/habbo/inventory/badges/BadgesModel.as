package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(var_759[_loc2_] == param1)
            {
               var_759.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         ...
         {
            _loc2_ = var_243[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_243.length)
               {
                  if((var_243[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_243[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      {
         if(param1 == InventoryCategory.const_254 && false)
         {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_363.getBadgeImage(param1);
            var_243.push(_loc8_);
            if(param2)
            {
