package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1396:int = 5;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_467 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_932 > 0)
            {
               var_17.close();
               var_17.unload();
               addRequestCounterToUrlRequest(var_322,const_1396 - var_932);
               var_17.load(var_322,_context);
               --var_932;
               return true;
            }
