package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1168:int = 10000;
      ...
      private var var_725:IEncryption;
      ...
      private var var_603:IProtocol;
      
      private var var_889:IMessageClassManager;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         var_889 = new MessageClassManager();
         var_77 = new Socket();
         var_359 = new Timer(const_1168,1);
         var_359.addEventListener(TimerEvent.TIMER,onTimeOutTimer);
      ...
      {
         var_359.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - var_726));
      ...
      {
         var_359.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - var_726));
      ...
      private function onConnect(param1:Event) : void
      {
         var_359.stop();
         var_1309 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - var_726));
         dispatchEvent(param1);
      }
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc4_:int = this.var_889.getMessageComposerID(param1);
         if(_loc4_ < 0)
         {
            return false;
         }
         var _loc5_:ByteArray = var_603.encoder.encode(_loc4_,param1.getMessageArray(),param2);
         if(var_360)
         {
         ...
         if(var_725 != null)
         {
            _loc3_ = var_725.encipher(_loc5_);
         }
         else
         {
            _loc3_ = _loc5_;
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         while(false)
         {
            var_361.writeByte(var_77.readUnsignedByte());
         }
      }
      ...
      {
         var_297.addConnectionMessageEvent(_id,param1);
      }
      ...
      {
         var_889.registerMessages(param1);
      }
      ...
      {
         var_359.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - var_726));
         dispatchEvent(param1);
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var _loc2_:uint = var_603.getMessages(var_361,_loc1_);
         ...
         for each(_loc4_ in _loc1_)
         {
            ...
            _loc7_ = var_889.getMessageEventClasses(_loc5_);
            _loc8_ = new Array();
            for each(_loc9_ in _loc7_)
            {
               _loc13_ = var_297.getMessageEvents(this,_loc9_);
            ...
            for each(_loc12_ in _loc8_)
            {
               ...
               if(_loc14_ != null)
               {
                  ...
                  if(_loc14_ != _loc11_)
                  {
                     ...
                     _loc10_ = var_297.getMessageParser(_loc14_);
                     if(_loc10_.flush())
                     {
         ...
         else if(_loc2_ > 0)
         {
            ...
            _loc18_.writeBytes(var_361,_loc2_);
            var_361 = _loc18_;
         }
      }
      ...
      {
         var_359.delay = param1;
      }
      
      private function onIOError(param1:IOErrorEvent) : void
      {
         var_359.stop();
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - var_726));
         switch(param1.type)
         {
      ...
      private function onClose(param1:Event) : void
      {
         var_359.stop();
         var_1309 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - var_726));
         dispatchEvent(param1);
      }
      ...
      override public function toString() : String
      {
         ...
         return _loc1_ + ("Encryption: " + var_725 + "\n");
      }
   }
}
