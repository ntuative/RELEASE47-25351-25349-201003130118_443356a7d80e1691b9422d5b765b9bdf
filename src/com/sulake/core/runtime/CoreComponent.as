package com.sulake.core.runtime
{
   ...
   public final class CoreComponent extends ComponentContext implements ICore
   {
      ...
      private static const const_1107:String = "zip-libraries";
      ...
      private static const const_1109:String = "service-libraries";
      ...
      private var var_1314:IEventDispatcher;
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1390);
      ...
      private function debugFrameUpdateHandler(param1:Event) : void
      {
         ...
         var _loc3_:uint = _loc2_ - var_270;
         var_270 = _loc2_;
         _loc4_ = 0;
         while(_loc4_ < CoreComponent.const_134)
         {
      ...
      private function updateLoadingEventDelegate() : void
      {
         ...
         if(var_1314)
         {
            _loc1_ = NaN + (var_1548 > 0 ? var_1548 + var_237.length - 1 : var_237.length);
            if(_loc1_ > 0)
            {
               var_1314.dispatchEvent(new ProgressEvent(ProgressEvent.PROGRESS,false,false,Number(var_269) - _loc1_,Number(var_269)));
            }
            else
            {
               var_1314.dispatchEvent(new Event(Event.COMPLETE));
            }
         }
      }
      ...
      private function simpleFrameUpdateHandler(param1:Event) : void
      {
         ...
         var msSinceLastUpdate:uint = msCurrentTime - var_270;
         var_270 = msCurrentTime;
         criticality = 0;
