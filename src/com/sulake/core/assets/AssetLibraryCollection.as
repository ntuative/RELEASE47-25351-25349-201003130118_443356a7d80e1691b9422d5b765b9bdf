package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_467:XML;
      
      protected var var_1108:LoaderContext;
      
      protected var var_33:Array;
      
      protected var var_528:Array;
      
      private var var_629:uint = 0;
      
      protected var var_371:AssetLibrary;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_33 = new Array();
         var_528 = new Array();
         var_1108 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_371 = new AssetLibrary("lib-" + var_629++);
         var_33.push(var_371);
      }
      
      public function createAsset(param1:String, param2:AssetTypeDeclaration) : IAsset
      {
         return var_371.createAsset(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_371.getAssetTypeDeclarationByFileName(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_528.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      {
         return var_371.registerAssetTypeDeclaration(param1,param2);
      }
      ...
      {
         return var_371.loadAssetFromFile(param1,param2,param3);
      }
      ...
      {
         return var_371.setAsset(param1,param2,param3);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_371.getAssetTypeDeclarationByClass(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_629++);
         var_528.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE)
         {
            ...
            _loc4_ = 0;
            while(_loc4_ < var_528.length)
            {
               _loc3_ = var_528[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_528.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
      ...
      {
         return var_371.loadFromResource(param1,param2);
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            return var_371.getAssetTypeDeclarationByMimeType(param1,true);
         }
         _loc3_ = 0;
         _loc6_ = 0;
         while(_loc6_ < _loc3_)
      ...
      {
         return var_371.loadFromArchive(param1,param2);
      }
