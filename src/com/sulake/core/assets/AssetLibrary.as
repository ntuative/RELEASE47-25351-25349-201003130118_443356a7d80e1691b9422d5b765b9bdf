package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_986:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_566:uint = 0;
      
      public static const const_994:String = "AssetLibraryReady";
      
      public static const const_1353:String = "AssetLibraryUnloaded";
      
      public static const const_437:String = "AssetLibraryLoaded";
      
      public static const const_1302:String = "AssetLibraryLoadError";
       
      
      private var var_467:XML;
      ...
      private var var_466:Boolean = true;
      
      private var var_334:Class;
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_396)
         {
            _loc4_ = AssetTypeDeclaration(var_396[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_395)
         {
            _loc2_ = var_395[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_395[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_656)
         {
            delete var_656[_loc1_];
         }
         if(var_17 != null)
         {
            var_17.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_467 = _loc2_.manifest.copy();
         var_334 = _loc2_.resource;
         if(var_466)
         {
            AssetLibrary.fetchLibraryContents(this,var_467,var_334);
         }
         var_301 = true;
         dispatchEvent(new Event(AssetLibrary.const_437));
         dispatchEvent(new Event(AssetLibrary.const_994));
         if(var_466)
         {
            var_17.dispose();
            var_17 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_395[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_864,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_805,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_395[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_396.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_396[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_986.splice(var_986.indexOf(this),1);
            --var_566;
            var_395 = null;
            var_656 = null;
            _loadedAssets = null;
      ...
      {
         return param1 < var_335.length ? getAssetByName(var_335[param1]) : null;
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_396)
         {
            _loc3_ = AssetTypeDeclaration(var_396[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_467.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_334[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_395[loader.url];
         if(struct == null)
         {
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in _loadedAssets)
            {
               if(_loadedAssets[_loc2_] == param1)
               {
                  var_335.splice(var_335.indexOf(_loc2_),1);
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_396[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_334 != null ? false : false;
      }
   }
}
