package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1202:uint = 0;
      ...
      protected var var_623:Function;
      ...
      protected var var_753:uint = 10;
      
      protected var var_18:IGraphicContext;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(!var_18)
         {
            var_18 = getGraphicContext(!testParamFlag(WindowParam.const_32));
         }
         ...
         if(_loc12_ != null)
         {
            var_366 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_55 = var_366.clone();
            var_7 = var_366.clone();
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_110,WindowParam.const_156);
         var _loc2_:* = !testParamFlag(WindowParam.const_106,WindowParam.const_141);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_7.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_16 & 0);
               if(_loc5_ == WindowParam.const_240)
               {
      ...
      {
         var_751 = param1;
         var_620 = !!var_751 ? uint(var_620 | var_1369) : uint(var_620 & 16777215);
      ...
      public function setupGraphicsContext() : IGraphicContext
      {
         ...
         if(false)
         {
            if(var_18.numChildContexts != numChildren)
            {
               _loc1_ = 0;
               for each(_loc2_ in _children)
               {
                  var_18.addChildContextAt(_loc2_.getGraphicContext(true),_loc1_++);
               }
            }
         }
         var_1000 = true;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1855 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_327:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_707:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_798:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_679:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_870:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_633:
               _loc2_ = "null";
               break;
         ...
         if(_loc2_ == WindowEvent.const_176)
         {
      ...
      public function swapChildrenAt(param1:int, param2:int) : void
      {
         ...
         var_18.swapChildContextsAt(param1,param2);
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_18)
         {
            var_18 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_566,var_7);
            var_18.visible = var_333;
         }
         return var_18;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_810,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      {
         var_423 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_7,WindowRedrawFlag.const_1006);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         if(var_1000 || _loc3_.hasGraphicsContext())
         {
            ...
            if(_loc3_.getGraphicContext(true).parent != var_18)
            {
               var_18.addChildContextAt(_loc3_.getGraphicContext(true),param2);
            }
         }
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_317,this,param1));
         return param1;
      }
      ...
      public function swapChildren(param1:IWindow, param2:IWindow) : void
      {
         ...
         if(param1 != null && param2 != null && param1 != param2)
         {
            ...
            {
               var_18.swapChildContexts(WindowController(param1).getGraphicContext(true),WindowController(param2).getGraphicContext(true));
            }
         }
      }
      ...
      {
         return !testParamFlag(WindowParam.const_32) || var_18 != null;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_753);
      }
      
      public function set color(param1:uint) : void
      {
         var_1369 = param1 & 4278190080;
         var_620 = !!var_751 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_7,WindowRedrawFlag.const_73);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_683))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_878;
                  if(testParamFlag(WindowParam.const_309))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_204:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_436,this,null));
                     if(testParamFlag(WindowParam.const_177,WindowParam.const_156))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_167,WindowParam.const_141))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_8 != null)
                     {
                        ...
                        var_16 = _loc8_;
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_268,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_360:
                  _context.invalidate(this,var_7.union(var_55),WindowRedrawFlag.const_359);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_912,this,null));
                     if(var_8 != null)
                     {
                        var_8.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_241,var_8,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_304:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_546,this,null));
                     if(var_8 != null)
                     {
                  ...
                  break;
               case WindowNotifyEvent.const_435:
                  _context.invalidate(this,var_7,WindowRedrawFlag.const_875);
                  break;
               case WindowNotifyEvent.const_393:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_369:
                  if(!(var_16 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_7,WindowRedrawFlag.const_359);
                     }
                  }
                  else if(var_16 & 0)
                  {
               ...
               case WindowNotifyEvent.const_195:
                  ...
                  break;
               case WindowNotifyEvent.const_436:
                  var_8.getRegionProperties(null,var_304);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_317:
      ...
      {
         return var_623 != null ? var_623 : (var_8 != null ? var_8.procedure : nullEventProc);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_753);
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         {
            var_18.removeChildContext(_loc3_.getGraphicContext(true));
         }
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_633,this,param1));
         return param1;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_679;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         {
            setupGraphicsContext();
            if(_loc2_.getGraphicContext(true).parent != var_18)
            {
               var_18.addChildContext(_loc2_.getGraphicContext(true));
            }
         }
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_317,this,param1));
         return param1;
      ...
      public function setChildIndex(param1:IWindow, param2:int) : void
      {
         ...
         if(_loc3_ > -1 && param2 != _loc3_)
         {
            ...
            {
               var_18.setChildContextIndex(_loc4_.getGraphicContext(true),getChildIndex(_loc4_));
            }
         }
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            _loc7_ = uint(var_16 & 0);
            if(_loc7_ == WindowParam.const_405)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_900,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_638,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_360,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_204,this,null));
            }
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1242,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_65,true);
         _loc1_.type = WindowNotifyEvent.const_1366;
         update(this,_loc1_);
         return true;
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         _context.invalidate(this,param1,WindowRedrawFlag.const_73);
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1391,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_8 != param1)
         {
            ...
            else
            {
               ...
               var_304.width = 0;
               var_304.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_870,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_80,var_16,_context,var_7,null,var_623,properties,var_621.concat(),_id) as WindowController;
         _loc2_.var_753 = var_753;
         _loc2_.var_161 = var_161;
         _loc2_._debug = _debug;
         _loc2_.var_304 = var_304.clone();
         _loc2_.var_7 = var_7.clone();
         _loc2_.var_366 = var_366.clone();
         ...
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_320;
         _loc2_.background = var_751;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_593;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_753 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      {
         if(var_35 == WindowState.const_355)
         {
            return true;
         }
         var_35 = WindowState.const_355;
