package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, IUpdateReceiver
   {
      ...
      public static var var_1594:IMouseCursor;
      
      public static const const_1507:int = 2;
      
      private static var var_1042:Factory;
      ...
      public static const const_1526:int = 3;
      ...
      private var var_705:WindowController;
      ...
      protected var var_2277:IInternalWindowServices;
      
      protected var var_95:WindowController;
      
      protected var var_1380:int = -1;
      
      protected var var_88:IDesktopWindow;
      
      private var var_1508:Boolean = false;
      
      protected var var_2354:Boolean = true;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_325 = param5;
         var_2277 = new InternalWindowServices(this,param5);
         var_2279 = param3;
         var_2278 = new WindowParser(this);
         var_668 = new Date();
         if(var_1042 == null)
         {
            var_1042 = new Factory();
         }
         if(var_927 == null)
         {
         ...
         var_325.addChild(var_88.getDisplayObject());
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_355)
         {
            param1.destroy();
         }
         return true;
      ...
      {
         var _loc12_:Class = var_1042.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1214,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         var_325.removeChild(IGraphicContextHost(var_88).getGraphicContext(true) as DisplayObject);
         var_88.destroy();
         var_88 = null;
         var_1105.destroy();
         var_1105 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_88 != null && true)
         {
            if(var_325 is Stage)
            {
               var_88.width = Stage(var_325).stageWidth;
               var_88.height = Stage(var_325).stageHeight;
            }
            else
            {
               var_88.width = var_325.width;
               var_88.height = var_325.height;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_588.x || _loc2_.stageY != var_588.y)
            {
               ...
               _loc5_ = new Array();
               var_88.groupChildrenUnderPoint(var_588,_loc5_);
            }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_95 && true)
                     {
                        if(var_360 != null)
                        {
                           var_360.mouseEventReceived(_loc2_.type,var_95);
                        }
                     }
                  }
                  if(_loc2_.altKey)
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1594 == null)
         {
            var_1594 = new MouseCursorControl(var_325);
         }
         return var_1594;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_401))
         {
