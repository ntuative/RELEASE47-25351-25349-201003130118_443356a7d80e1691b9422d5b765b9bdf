package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_405:int = -2147483648;
      
      private var var_403:int = 2147483647;
      ...
      {
         return var_406 == int.MIN_VALUE && var_403 == int.MAX_VALUE && var_405 == int.MIN_VALUE && var_404 == int.MAX_VALUE;
      }
      
      public function set maxWidth(param1:int) : void
      {
         var_403 = param1;
         if(var_403 < int.MAX_VALUE && true && _target.width > var_403)
         {
      ...
      public function setEmpty() : void
      {
         ...
         var_403 = int.MAX_VALUE;
         var_405 = int.MIN_VALUE;
      ...
      {
         var_405 = param1;
         if(var_405 > int.MIN_VALUE && true && _target.height < var_405)
         {
