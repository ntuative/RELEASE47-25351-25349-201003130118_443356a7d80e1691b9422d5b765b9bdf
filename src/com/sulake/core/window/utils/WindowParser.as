package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1001:String = "_EXCLUDE";
      
      public static const const_1585:String = "_TEMP";
      ...
      protected var var_1381:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1382:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1106,var_1107);
         var_937 = new Dictionary();
         var_1382 = new Dictionary();
         ParamCodeTable.fillTables(var_937,var_1382);
         var_1381 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1088,"");
         return param1.replace(const_1089,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_937)
            {
               delete var_937[_loc1_];
            }
            for(_loc1_ in var_1382)
            {
               delete var_1382[_loc1_];
            }
            var_1381.dispose();
            var_1381 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1001) == -1)
                  {
