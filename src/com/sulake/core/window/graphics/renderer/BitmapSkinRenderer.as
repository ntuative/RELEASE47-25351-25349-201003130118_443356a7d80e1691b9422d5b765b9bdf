package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_625:Dictionary;
      
      private var var_750:Matrix;
      
      protected var var_626:Dictionary;
      
      public function BitmapSkinRenderer(param1:Array)
      {
         super(param1);
         var_626 = new Dictionary(false);
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = var_626[_loc3_];
         if(_loc4_ == null)
         {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            while(_loc18_ < _loc9_)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  {
                     var_750.a = _loc13_.width / _loc19_.width;
                     var_750.d = _loc13_.height / _loc19_.height;
                     _loc32_ = new BitmapData(_loc13_.width,_loc13_.height,false);
                     _loc32_.draw(_loc19_,var_750);
                     _loc33_ = new BitmapData(_loc13_.width,_loc13_.height,true,0);
                     _loc33_.draw(_loc20_,var_750,null);
      ...
      override public function dispose() : void
      {
         ...
         super.dispose();
         var_750 = null;
         for(_loc1_ in var_626)
         {
            _loc2_ = var_626[_loc1_] as BitmapData;
            _loc2_.dispose();
            delete var_626[_loc1_];
         }
         var_626 = null;
         for(_loc1_ in var_625)
         {
            _loc2_ = var_625[_loc1_] as BitmapData;
            _loc2_.dispose();
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = var_625[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
