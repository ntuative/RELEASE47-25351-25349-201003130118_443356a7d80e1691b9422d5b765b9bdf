package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1019:uint = 256;
      
      protected static var var_629:uint = 0;
      
      protected static var var_372:uint = 0;
      
      public static const const_907:uint = 2;
      
      public static const const_1505:uint = 128;
      
      public static const const_1449:uint = 64;
      
      public static const const_540:uint = 4;
      
      public static const const_1352:uint = 0;
      
      public static const const_1253:uint = 16;
      
      public static const const_566:uint = 1;
      
      public static const const_1247:uint = 8;
      ...
      protected var var_1599:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1253:
               ...
               break;
            case GraphicContext.const_540:
               setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1019:
               break;
         ...
         if(var_622)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new BitmapData(width,height,var_1599,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new BitmapData(1,1,var_1599,16777215);
                  }
                  var_372 += bitmap.width * bitmap.height * 4;
               }
