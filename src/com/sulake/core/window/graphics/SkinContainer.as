package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private var var_1873:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         TypeCodeTable.fillTables(var_1470,var_1872);
         var_1210 = new Dictionary();
         var_1873 = new Dictionary();
         StateCodeTable.fillTables(var_1210,var_1873);
         ...
         var_479["HabboCatalogCom_ctlg_bots"] = NullSkinRenderer;
         if(var_373 == null)
         {
            var_373 = new Array();
            var_373.push(WindowState.const_65);
            var_373.push(WindowState.const_71);
            var_373.push(WindowState.const_97);
            var_373.push(WindowState.const_48);
            var_373.push(WindowState.const_81);
            var_373.push(WindowState.const_74);
            var_373.push(WindowState.const_93);
            var_373.push(WindowState.const_88);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1210)
         {
            _loc3_.push(var_1210[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1470[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_573[param1] = new Array(SkinContainer.const_1074);
         }
