package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1069:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1600 == null)
         {
            var_1600 = findChildByTag(TabContextController.const_1068) as IWindowContainer;
         }
         return var_1600;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_933 == null)
         {
            var_933 = findChildByTag(TabContextController.const_1069) as ITabSelectorWindow;
            if(var_933 != null)
            {
      ...
      {
         return !!var_846 ? selector.iterator : null;
      }
