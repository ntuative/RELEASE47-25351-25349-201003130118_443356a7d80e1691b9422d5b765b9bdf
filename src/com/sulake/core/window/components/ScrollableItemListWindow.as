package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_818:IItemListWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_343)
         {
            ...
            if(var_343)
            {
               var_343.addEventListener(WindowEvent.const_252,scrollBarEventProc);
               var_343.addEventListener(WindowEvent.const_219,scrollBarEventProc);
            }
         }
         return var_343;
      }
      ...
      override public function dispose() : void
      {
         if(var_343)
         {
            var_343.removeEventListener(WindowEvent.const_252,scrollBarEventProc);
            var_343.removeEventListener(WindowEvent.const_219,scrollBarEventProc);
            var_343 = null;
         }
         if(var_818)
         {
      ...
      {
         if(param1.type == WindowEvent.const_252)
         {
            showScrollBar();
         }
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!var_818)
         {
            var_818 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
         return var_818;
      }
