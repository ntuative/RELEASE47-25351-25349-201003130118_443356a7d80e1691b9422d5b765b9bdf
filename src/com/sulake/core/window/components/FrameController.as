package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_754:String = "margin_top";
      
      private static const const_1070:String = "_HEADER";
      
      private static const const_757:String = "margin_right";
      
      private static const const_1071:String = "_SCALER";
      
      private static const const_1063:String = "_TITLE";
      
      private static const const_1072:String = "_CONTENT";
      
      private static const const_755:String = "margin_left";
      
      private static const const_756:String = "margin_bottom";
      ...
      private var var_1204:IHeaderWindow;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_755,_loc3_.left,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_754,_loc3_.top,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_757,0 - _loc3_.right,PropertyStruct.const_62,_loc2_));
         _loc1_.push(new PropertyStruct(const_756,0 - _loc3_.bottom,PropertyStruct.const_62,_loc2_));
         return _loc1_;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_220);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_225);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_220,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_220,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1204 == null)
         {
            var_1204 = findChildByTag(const_1070) as IHeaderWindow;
            if(!var_1204)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1063) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1071) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_234,false);
         }
      ...
      {
         return content != null && var_1371 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_21 == null)
         {
            var_21 = findChildByTag(const_1072) as IWindowContainer;
            if(!var_21)
            {
