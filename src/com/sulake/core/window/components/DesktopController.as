package com.sulake.core.window.components
{
   ...
   public class DesktopController extends ActivatorController implements IDesktopWindow, IDisplayObjectWrapper
   {
      ...
      {
         var_623 = param1 != null ? param1 : defaultProcedure;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_18)
         {
            var_18 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1019,var_7);
            GraphicContext(var_18).mouseEnabled = true;
            GraphicContext(var_18).doubleClickEnabled = true;
         }
         return var_18;
      }
