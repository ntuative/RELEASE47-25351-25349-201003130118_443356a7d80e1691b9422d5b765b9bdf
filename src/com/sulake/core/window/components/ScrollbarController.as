package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1059:String = "increment";
      
      private static const const_489:String = "slider_bar";
      
      private static const const_1060:String = "decrement";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(var_22 != null && true)
         {
            IWindow(var_22).removeEventListener(WindowEvent.const_45,onScrollableResized);
         }
         var_22 = param1;
         if(var_22 != null && true)
         {
            IWindow(var_22).addEventListener(WindowEvent.const_45,onScrollableResized);
            updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return track.findChildByName(ScrollbarController.const_489) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_804 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_804 != null)
         {
            _loc1_ = findParentByName(var_804) as IScrollableWindow;
            if(_loc1_ == null && var_8 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_8).findChildByName(var_804) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1059)
            {
               if(var_22)
               {
                  var_564 = true;
            ...
            else if(param2.name == ScrollbarController.const_1060)
            {
               if(var_22)
               {
                  var_564 = true;
         ...
         if(param1.type == WindowMouseEvent.const_876)
         {
