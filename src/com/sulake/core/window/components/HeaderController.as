package com.sulake.core.window.components
{
   ...
   public class HeaderController extends ContainerController implements IHeaderWindow
   {
      ...
      private static const const_1064:String = "_CONTROLS";
      ...
      {
         return findChildByTag(HeaderController.const_1063) as ITextWindow;
      }
      
      public function get controls() : IItemListWindow
      {
         return findChildByTag(HeaderController.const_1064) as IItemListWindow;
      }
   }
}
