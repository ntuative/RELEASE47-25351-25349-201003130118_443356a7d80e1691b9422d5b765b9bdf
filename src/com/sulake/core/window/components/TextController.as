package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2340:Rectangle = new Rectangle();
      ...
      {
         return new Rectangle(var_624 * maxScrollH,var_369 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_754)
         {
            context.removeLocalizationListener(var_320,this);
         }
         if(var_66 != null)
         {
            var_66.dispose();
      ...
      {
         var_624 = param1;
         _field.scrollH = var_624 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_320 = param1;
         if(var_320.charAt(0) == "$" && var_320.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_320.slice(2,var_320.indexOf("}")),this);
            var_754 = true;
         }
         else if(_field != null)
         {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_929,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_465,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_465,true));
         ...
         _loc1_.push(new PropertyStruct("margin_left",var_66.left,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_top",var_66.top,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_right",var_66.right,PropertyStruct.const_62,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_66.bottom,PropertyStruct.const_62,true));
