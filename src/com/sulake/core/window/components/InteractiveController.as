package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static const const_1397:uint = 500;
      ...
      protected var var_2275:uint = 0;
      
      protected var var_930:String = "";
      
      protected var var_443:Array;
      
      protected var var_931:uint = 500;
      
      public function InteractiveController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         param4 |= 0;
         var_443 = new Array();
         var_443[0] = MouseCursorType.const_325;
         var_443[1] = MouseCursorType.const_38;
         var_443[2] = MouseCursorType.const_325;
         var_443[3] = MouseCursorType.const_325;
         var_443[4] = MouseCursorType.const_38;
         var_443[5] = MouseCursorType.const_38;
         var_443[6] = MouseCursorType.const_325;
         if(var_326 == null)
         {
            var_326 = new Array();
            var_326[0] = WindowState.const_93;
            var_326[1] = WindowState.const_74;
            var_326[2] = WindowState.const_81;
            var_326[3] = WindowState.const_65;
            var_326[4] = WindowState.const_48;
            var_326[5] = WindowState.const_97;
            var_326[6] = WindowState.const_71;
         }
      ...
      {
         param2.push(new PropertyStruct(const_1024,param1.toolTipCaption,PropertyStruct.STRING,param1.toolTipCaption != const_739));
         param2.push(new PropertyStruct(KEY_TOOLTIP_DELAY,param1.toolTipDelay,PropertyStruct.const_929,param1.toolTipDelay != const_1397));
         return param2;
      }
      ...
      {
         var_930 = param1 == null ? const_739 : param1;
      }
