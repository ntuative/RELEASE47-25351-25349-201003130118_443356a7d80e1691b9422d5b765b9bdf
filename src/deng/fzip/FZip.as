package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_490 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      protected function progressHandler(param1:Event) : void
      {
         ...
         {
            close();
            if(!hasEventListener(FZipErrorEvent.const_538))
            {
               throw e;
            }
            dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_538,e.message));
         }
      }
      ...
      public function loadBytes(param1:ByteArray) : void
      {
         if(!var_94 && parseFunc == parseIdle)
         {
            ...
            {
               dispatchEvent(new FZipErrorEvent(FZipErrorEvent.const_538,"EOF"));
            }
         }
      }
      ...
      {
         if(var_490.parse(param1))
         {
            var_47.push(var_490);
            if(false)
            {
               var_133["null"] = var_490;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1241,var_490));
            var_490 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_47 != null && var_133 != null && param1 < var_47.length)
         {
